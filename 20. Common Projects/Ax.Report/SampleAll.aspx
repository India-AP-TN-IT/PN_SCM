<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sampleall.aspx.cs" Inherits="sampleall" %>
<html>
<head>
...
function fnOpen2()
{
	...
	oReport.rptname = "DBTest";
	//oReport.rptname = "한글reb파일";
	//oReport.rptname = "http://localhost:8080/test/speed.reb";
	//oReport.rptname = "http://localhost.com:8080/getreport.jsp?filename=한글reb파일";
	//oReport.rptname = "samples/customers";
	//oReport.rptname = "samples/emp";
	//oReport.rptname = "speedtest";
...
function fnOpenEach()
{
	...
	*/
	...
	oReport.con("ADO1").type = "file";
	oReport.con("ADO1").datatype = "xml";
	oReport.con("ADO1").path = "http://" + location.host + "/rebfiles/samples/sqlserver_customers_orders.xml";
	oReport.con("ADO1").dataset("ADOSQLDS1").xpath = "gubun/rpt1/rexdataset/rexrow";
...
function fnOpenMulti()
{
	...
	**/
	...
	oReport.reb("reb2").con("ADO1").path = "http://" + location.host + "/rebfiles/samples/sqlserver_customers_orders.xml";
	...
	*/
	...
	oReport.reb("reb2").path = "http://" + location.host + "/rebfiles/samples/sqlserver_customers_orders.xml";
...
function fnOpenMulti_MainSub()
{
	...
	oReport.reb("reb1").con("XML1").path = "http://" + location.host + "/rebfiles/samples/sqlserver_customers_orders.xml";
	...
	oReport.reb("reb2").con("XML1").path = "http://" + location.host + "/rebfiles/samples/sqlserver_customers_orders.xml";
	...
	oReport.reb("reb3").con("XML1").path = "http://" + location.host + "/rebfiles/samples/sqlserver_customers_orders.xml";
...
<body>
	...
	&nbsp;<button onclick="fnOpen2();">레포트 보기(UserConnectionString)</button>
	...
	<iframe name="ifrmRexPreview1" id="ifrmRexPreview1" src='rexpreview.aspx' width="100%" height="400"></iframe>
	...
	<!--  plugin
	<SCRIPT language=JavaScript SRC="/plugin/markany/js/markany.js"></SCRIPT>
	<SCRIPT language=JavaScript SRC="/plugin/bcqre/js/bcqre.js"></SCRIPT>
	-->
</body>
</html>