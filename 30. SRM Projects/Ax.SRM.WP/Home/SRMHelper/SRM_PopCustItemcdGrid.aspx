<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_PopCustItemcdGrid.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_PopCustItemcdGrid" %>
...
<head id="Head1" runat="server">
    ...
    <title>Customer Item Search Popup</title>
...
<body>
    ...
    <ext:TextField ID="txt01_VENDCD" runat="server" Hidden="true"></ext:TextField>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_PopCustItemcdGrid" runat="server" /><%--Text="Customer Item Search" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_CUST_ITEMCD" runat="server" /><%--Text="Cust Itemcd"  --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_CUST_ITEMCD" runat="server" Width="120">
                                    <Listeners>
                                        <Change Handler="App.txt01_CUST_ITEMNM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl01_CUST_ITEMNM" runat="server" /><%--Text="Cust Itemnm" --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_CUST_ITEMNM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="CUST_ITEMCD" runat="server" DataIndex="CUST_ITEMCD" Width="95" Align="Center" /><%--Text="고객품목코드" --%>
                                <ext:Column ID="CUST_ITEMNM" runat="server" DataIndex="CUST_ITEMNM" fLEX="1" MinWidth="150" Align="Left" /><%--Text="고객품목명"--%> 
                                <ext:Column ID="WORK_DIR_DIVNM" itemID="WORK_DIR_DIV2" runat="server" DataIndex="WORK_DIR_DIVNM" Align="Left" Width="70" /><%--Text="작업지시"--%> 
                                <ext:Column ID="VINNM" runat="server" itemID="VIN" DataIndex="VINNM" Align="Left" Width="60"/><%--Text="차종"--%> 
                                <ext:Column ID="CUSTNM" runat="server" DataIndex="CUSTNM" Align="Left" Width="150"/><%--Text="고객사명" --%>
                            </Columns>
                        </ColumnModel>
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_CUST_ITEMCD">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_CUST_ITEMNM">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
