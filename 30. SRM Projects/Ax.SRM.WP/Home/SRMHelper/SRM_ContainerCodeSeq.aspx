<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_ContainerCodeSeq.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_ContainerCodeSeq" %>
...
<head id="Head1" runat="server">
    ...
    <title>Container Search Popup</title>
...
<body>
    <form id="SRM_ContainerCodeSeq" runat="server">
    ...
    <ext:TextField ID="txt01_INPUT_DATE" runat="server" Hidden="true"></ext:TextField>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_CONTNM" runat="server" /><%--Text="Container Search" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_CONTCD" runat="server" Width="110" /><%--Text="Container Code"  --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_CONTCD" runat="server" Width="100">
                                    <Listeners>
                                        <Change Handler="App.txt01_CONTNM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl02_CONTNM" runat="server" Width="110" /><%--Text="Container Name" --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_CONTNM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel2" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="CONTCD" ItemID="CONTCD" runat="server" DataIndex="CONTCD" Width="100" Align="Center" />
                                <ext:Column ID="CONTNM" ItemID="CONTNM" runat="server" DataIndex="CONTNM" Align="Left" Flex="1" />
                                <ext:Column ID="UNIT" ItemID="UNIT" runat="server" DataIndex="UNIT" Width="40" Align="Center" />
                                <ext:Column ID="PACK_QTY" ItemID="UNIT_PACK_QTY_SIM" runat="server" DataIndex="PACK_QTY" Width="60" Align="Right" />
                            </Columns>
                        </ColumnModel>
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_CONTCD">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_CONTNM">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
