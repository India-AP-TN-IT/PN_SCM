<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_CustomerCode.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_CustomerCode" %>
...
<body>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_CustomerCode" runat="server" /><%--Text="Customer Search" />--%>
                ...
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            ...
                            <td>
                                <ext:TextField ID="txt01_CUSTCD" runat="server" Width="100">
                                    <Listeners>
                                        <Change Handler="App.txt01_CUSTNM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                            ...
                            <td>
                                <ext:TextField ID="txt01_CUSTNM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_CUSTCD">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_CUSTNM">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
