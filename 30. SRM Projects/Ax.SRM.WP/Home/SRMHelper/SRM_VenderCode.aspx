<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_VenderCode.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_VenderCode" %>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North" >
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_VenderCode" runat="server" /><%--Text="Vender Search" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_VENDCD" runat="server" Width="110" /><%--Text="Vender Code"  --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_VENDCD" runat="server" Width="100">
                                    <Listeners>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="VENDCD" ItemID="VENDCD" runat="server" DataIndex="VENDCD" Width="60" Align="Center" /><%--Text="VendCd"--%> 
