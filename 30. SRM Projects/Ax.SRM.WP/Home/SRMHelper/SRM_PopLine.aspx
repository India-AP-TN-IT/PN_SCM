<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_PopLine.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_PopLine" %>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_PopLine" runat="server" /><%--Text="Line Search" />--%>
