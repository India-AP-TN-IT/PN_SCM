<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_PopCustPlantcdGrid.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_PopCustPlantcdGrid" %>
...
<head id="Head1" runat="server">
    ...
    <title>Customer Plant Search Popup</title>
...
<body>
    <form id="SRM_PopCustPlantcdGrid" runat="server">
    ...
    <ext:TextField ID="txt01_VENDORCD" runat="server" Hidden="true"></ext:TextField>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_PopCustPlantcdGrid" runat="server" />
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_PLANTCD" runat="server" Width="110" />
                            </th>
                            <td>
                                <ext:TextField ID="txt01_PLANTCD" runat="server" Width="120">
                                    <Listeners>
                                        <Change Handler="App.txt01_PLANTNM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl01_PLANTNM" runat="server" Width="110" />
                            </th>
                            <td>
                                <ext:TextField ID="txt01_PLANTNM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <Model>
                                    <ext:Model runat="server">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="PLANT_TYPE" />
                                            <ext:ModelField Name="PLANT_TYPENM" />
                                            <ext:ModelField Name="FIRM_DST" />
                                            <ext:ModelField Name="DELI_REQ_TIME" />
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="PLANTCD" ItemID="PLANTCD" runat="server" DataIndex="PLANTCD" Width="70" Align="Center" />
                                <ext:Column ID="PLANTNM" ItemID="PLANTNM" runat="server" DataIndex="PLANTNM" fLEX="1" MinWidth="150" Align="Left" />
                                <ext:Column ID="PLANT_TYPENM" ItemID="PLANT_TYPE" runat="server" DataIndex="PLANT_TYPENM" Align="Left" Width="70" />                                
                                <ext:NumberColumn ID="FIRM_DST" ItemID="FIRM_DST" runat="server" DataIndex="FIRM_DST" Width="120" Align="Right" Format="#,##0" />
                                <ext:Column ID="CUSTNM" ItemID="CUSTNM" runat="server" DataIndex="CUSTNM" Align="Left" Width="150"/>
                            </Columns>
                        </ColumnModel>
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_PLANTCD">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_PLANTNM">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
