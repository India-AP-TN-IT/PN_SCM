<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_PopEmpno.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_PopEmpno" %>
...
<head id="Head1" runat="server">
    ...
    <title>empno Search Popup</title>
...
<body>
    <form id="SRM_PopEmpno" runat="server">
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North" >
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_PopEmpno" runat="server" /><%--Text="Vender Search" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_EMPNO" runat="server" Width="110" /><%--Text="Vender Code"  --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_EMPNO" runat="server" Width="100">
                                    <Listeners>
                                        <Change Handler="App.txt01_EMPNM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl01_EMPNM" runat="server" Width="110" /> <%--Text="Vender Name"--%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_EMPNM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                ...
                <Items>
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                <ext:RowNumbererColumn ID="NO" runat="server" Width="45" Text="No" Align="Left" />
                                <ext:Column ID="EMPNO" ItemID="EMPNO" runat="server" DataIndex="EMPNO" Width="80" Align="Left" /><%--Text="사번"--%> 
                                <ext:Column ID="NAME_KOR" ItemID="NAME_KOR" runat="server"  DataIndex="NAME_KOR" Width="80" Align="Left" /><%--Text="성명"--%>
                                <ext:Column ID="DEPART" ItemID="DEPART" runat="server"  DataIndex="DEPART" Width="120" Align="Left" /><%--Text="부서"--%>
                                <ext:Column ID="MOB_PHONE_NO" ItemID="MOB_PHONE_NO" runat="server"  Width="120" DataIndex="MOB_PHONE_NO" Align="Left" /><%--Text="Address"--%>
                                <ext:Column ID="Column1" ItemID="Column1" runat="server"  MinWidth="1" DataIndex="Column1" fLEX="1" Align="Left" /><%--Text="Address"--%>
                            </Columns>
                        </ColumnModel>
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_EMPNO">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_EMPNM">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
