<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_PopLineSeq.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_PopLineSeq" %>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_PopLineSeq" runat="server" /><%--Text="Line Search" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_LINECD" runat="server" /><%--Text="Cust Itemcd" --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_LINECD" runat="server" Width="120">
                                    <Listeners>
                            ...
                            <th>
                                <ext:Label ID="lbl01_LINENM" runat="server" /><%--Text="Cust Itemnm"--%>
                            </th>
                            <td>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="LINECD" runat="server" DataIndex="LINECD" Width="80" Align="Center" /><%--Text="라인코드" --%>
                                <ext:Column ID="LINENM" runat="server" DataIndex="LINENM" fLEX="1" MinWidth="150" Align="Left" /><%--Text="라인명" --%>
