<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_VenderCodeFree.aspx.cs" Inherits="Ax.SRM.WP.Home.SRMHelper.SRM_VenderCodeFree" %>
...
<body>
    <form id="SRM_VenderCode" runat="server">
    ...
    <ext:TextField ID="OPTION" runat="server" Hidden="true"></ext:TextField>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North" >
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_VenderCodeFree" runat="server" /><%--Text="협력업체조회" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_T1_VENDCD" runat="server" Width="110" /><%--Text="Vender Code"  --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_VENDCD_FREE" runat="server" Width="100">
                                    <Listeners>
                                        <Change Handler="App.txt01_VENDNM_FREE.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl01_VENDNM" runat="server" Width="110" /> <%--Text="Vender Name"--%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_VENDNM_FREE" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="T1_VENDCD" ItemID="T1_VENDCD" runat="server" DataIndex="VENDCD" Width="60" Align="Center" /><%--Text="VendCd"--%> 
                                <ext:Column ID="VENDNM" ItemID="VENDNM" runat="server"  DataIndex="VENDNM" Width="180" Align="Left" /><%--Text="VendName"--%>
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_VENDCD_FREE">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_VENDNM_FREE">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
