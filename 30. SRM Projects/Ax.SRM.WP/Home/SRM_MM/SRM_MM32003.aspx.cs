...
{
    public partial class SRM_MM32003 : BasePage
    {
        private string pakageName = "APG_SRM_MM32003";
        ...
        private void SetCombo()
        {
            ...
            /*
            source = Library.GetTypeCode("1D").Tables[0];
            Library.ComboDataBind(this.cbo01_RCV_DIV, source.DefaultView.ToTable(), true, "OBJECT_NM", "OBJECT_ID", true);
            this.cbo01_RCV_DIV.UpdateSelectedItems(); //꼭 해줘야한다.
            */
            ...
            source = Library.GetTypeCode("1H").Tables[0];
            Library.ComboDataBind(this.cbo01_MOVE_CODE, source.DefaultView.ToTable(), true, "OBJECT_NM", "TYPECD", true);
            this.cbo01_MOVE_CODE.UpdateSelectedItems(); //꼭 해줘야한다.
        }
        ...
        public void Reset()
        {
            ...
            this.cdx01_RCV_DIV.SetValue(string.Empty);
        ...
        private DataSet getDataSet()
        {
            ...
            param.Add("RCV_DIV", cdx01_RCV_DIV.Value);
            param.Add("DELI_NOTE", txt01_DELI_NOTE.Value);
            param.Add("MOVE_CODE", cbo01_MOVE_CODE.Value);
        ...
        public bool IsQueryValidation()
        {
            ...
            {
                this.MsgCodeAlert_ShowFormat("EP20S01-003", "df01_FROM_DATE", lbl01_RCV_DATE.Text);
                return false;
            }
        ...
        public void MakePopUp(String[] arr, string type)
        {
            ...
            else if (type.Equals("D"))
            {
                param.Add("CORCD", UserInfo.CorporationCode);
                param.Add("BIZCD", cbo01_BIZCD.Value);
                param.Add("PONO", arr[0].Split('-')[0]);
                param.Add("PARTNO", arr[1]);
                param.Add("PARTNM", arr[2]);
                param.Add("UNIT", arr[3]);
                param.Add("PONO_SEQ", arr[0].Split('-')[1]);
                Util.UserPopup((BasePage)this.Form.Parent.Page, "../SRM_MM/SRM_MM32003P1.aspx", param, "HELP_MM32003P1", "Popup", 800, 600);
            }
        }
        #endregion
    }
