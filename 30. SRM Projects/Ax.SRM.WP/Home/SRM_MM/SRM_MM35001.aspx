<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM35001.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM35001" %>
...
<body>
    <form id="SRM_MM35001" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM35001" runat="server" Cls="search_area_title_name" /><%--Text="서열투입계획(직/준서열)" />--%>
                    ...
                    <table style="height:0px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <epc:EPCodeBox ID="cdx01_VENDCD" runat="server" HelperID="HELP_VENDCD" PopupMode="Search" PopupType="HelpWindow" 
                                    OnAfterValidation="cdx01_VENDCD_AfterValidation"  WidthTYPECD="60"/>                                    
                            </td>   
                            <th class="ess">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<ext:SelectBox ID="cbo01_VINCD" runat="server"  Mode="Local" ForceSelection="true"
                                    DisplayField="TYPECD" ValueField="VINCD" TriggerAction="All" Width="115" >
                                    <Store>
