...
{
    /// <summary>
    /// <b>자재관리>발주관리>발주정보 조회(납기일자별) 납품량 상세조회(Popup)</b>
    /// - 작 성 자 : 손창현<br />
    /// - 작 성 일 : 2017-09-18<br />
    /// </summary>
    public partial class SRM_MM31007P2 : BasePage
    {
        /// <summary>
        /// SRM_MM31007P2 생성자
        /// </summary>
        public SRM_MM31007P2()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ds = EPClientHelper.ExecuteDataSet("APG_SRM_MM31007.INQUERY_POP2", param, "OUT_CURSOR");
