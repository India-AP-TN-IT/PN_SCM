...
{
    public partial class SRM_MM33003 : BasePage
    {
        private string pakageName = "APG_SRM_MM33003";
        ...
        public void Reset()
        {
            ...
            this.df01_ARRIV_DATE.SetValue(string.Empty);
            this.df01_RCV_DATE.SetValue(string.Empty);
        ...
        private DataSet getDataSet()
        {
            ...
            param.Add("ARRIV_DATE", this.df01_ARRIV_DATE.IsEmpty ? "" : ((DateTime)this.df01_ARRIV_DATE.Value).ToString("yyyy-MM"));
            param.Add("RCV_DATE", this.df01_RCV_DATE.IsEmpty ? "" : ((DateTime)this.df01_RCV_DATE.Value).ToString("yyyy-MM"));
