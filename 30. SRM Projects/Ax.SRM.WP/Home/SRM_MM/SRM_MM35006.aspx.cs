...
{
    public partial class SRM_MM35006 : BasePage
    {
        private string pakageName = "APG_SRM_MM35006";        
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!X.IsAjaxRequest)
                {
                    ...
                    //Library.ComboDataBind(this.cbo01_LOG_DIV, Library.GetTypeCode("EB").Tables[0], false, "OBJECT_NM", "OBJECT_ID", true);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void CodeBox_LINE_BeforeDirectButtonClick(object sender, DirectEventArgs e)
        {
            ...
            cdx.UserParamSet.Add("INPUT_DATE", ((DateTime)this.df01_STD_DATE.Value).ToString("yyyy-MM-dd"));
        }
        ...
        public bool IsQueryValidation()
        {
            ...
            {
                this.MsgCodeAlert_ShowFormat("EP20S01-003", "df01_STD_DATE", lbl01_DELIVERYDATE.Text);
                return false;
            }
            return true;
        }
