...
{
    public partial class SRM_MM32007 : BasePage
    {
        private string pakageName = "APG_SRM_MM32007";
        ...
        {            
            ...
            if (type.Equals("M"))
            {
                ...
                param.Add("DATE_FROM", "2017-01-01");
                param.Add("DATE_TO", "9998-12-31");
                param.Add("DIV", "D");
                param.Add("CUSTCD", "");
                //입하정보
        ...
        public void PrintCheck(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                printReport(deliDate, deliNote, sourcingDiv, purcOrg, purcPoType, arriveDate);
            }
            catch (Exception ex)
            {
                this.ErrorMessageAlert(this, ex);  // Error message server logging and Display message on UI Screen
        ...
        private void printReport(string deliDate, string deliNote, string sourcingDiv, string purcOrg, string purcPoType, string arriveDate)
        {
            //출력 가능여부 체크
            if (IsPrintable(deliDate, deliNote))
            {
                ...
                else// if (sourcingDiv.Equals("1I100"))
                {
                    //1I100:입고
                    //거래명세표 리포트 호출 (E2A)
                    printReportE2A(deliDate, deliNote, arriveDate);
                }
            }
        }
        ...
        /// 거래명세표 출력
        /// </summary>
        private void printReportE2A(string deliDate, string deliNote, string arriveDate)
        {
            try
            {
