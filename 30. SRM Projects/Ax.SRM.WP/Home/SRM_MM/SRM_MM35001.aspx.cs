...
{
    public partial class SRM_MM35001 : BasePage
    {
        private string pakageName = "APG_SRM_MM35001";
        ...
        public void cdx01_VENDCD_AfterValidation(object sender, DirectEventArgs e)
        {
            ...
            //DataSet source = EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", pakageName, "INQUERY_VINCD"), param);

            //Library.ComboDataBind(this.cbo01_VINCD, source.Tables[0], false, "TYPECD", "VINCD", true);
        }
