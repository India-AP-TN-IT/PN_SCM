<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM35004.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM35004" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var CellDbClick = function (grid, obj1, cellIndex, obj2, obj3, rowIndex, obj4) {
            ...
            App.direct.Cell_DoubleClick(qty, partno, barcode, delidate, delicnt);
        }

    </script>
</head>
<body>
    <form id="SRM_MM35004" runat="server">
    ...
    <ext:TextField ID="UserHelpURL" runat="server" Hidden="true" Text="../SCM_QA/SCM_QA23001P1.aspx"></ext:TextField> 
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM35004" runat="server" Cls="search_area_title_name" /><%--Text="차종별 서열지 출력(직서열)" />--%>
                ...
                <Content>
                    <table style="height:0px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <ext:SelectBox ID="cbo01_MAT_ITEM" runat="server"  Mode="Local" ForceSelection="true"
                                    DisplayField="TYPECD" ValueField="OBJECT_ID" TriggerAction="All" Width="200">
                                    <Store>
                        ...
                        <tr>
                             <th class="ess">         
                                <ext:Label ID="lbl01_CHASU" runat="server" /><%--Text="납품차수" />   --%>                    
                            </th>
                            <td>
                                <ext:FieldContainer ID="FieldContainer1" runat="server" Width="160" Flex="1" MsgTarget="Side" Layout="TableLayout">
                                    <Items>
                                        <ext:TextField ID="txt01_FROM_CHASU" Width="50" Cls="inputText_Num" runat="server" MaskRe="/[0-9]/" MaxLengthText="1" MaxLength="1"/>
                                        <ext:DisplayField ID="DisplayField2" Width="30"  runat="server" FieldStyle="text-align:center;padding:3px;" Text=" ~ " />
                                        <ext:TextField ID="txt01_TO_CHASU" Width="50" Cls="inputText_Num" runat="server" MaskRe="/[0-9]/" MaxLengthText="1" MaxLength="1"/>
                            ...
                            <td colspan="3">
                              <ext:SelectBox ID="cbo01_SEQ_TYPE" runat="server"  Mode="Local" ForceSelection="true"
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="LINENM"              ItemID="DEL_STAGE"  runat="server" DataIndex="LINENM"        Width="165" Align="Left"/>              <%--Text="납품장소"--%>  
                                <ext:Column ID="JIS_CNT"             ItemID="DELI_CNT"   runat="server" DataIndex="JIS_CNT"       Width="70" Align="Center"/>               <%--Text="납품차수"--%>  
                                <ext:Column ID="PARTNO"              ItemID="PARTNO"     runat="server" DataIndex="PARTNO"        Width="130" Align="Left" />               <%--Text="PART NO"--%>   
                                <ext:Column ID="PARTNM"              ItemID="PARTNM"     runat="server" DataIndex="PARTNM"        MinWidth="150" Align="Left" Flex="1"/>    <%--Text="PART NAME"--%>                             
                                <ext:NumberColumn ID="MAT_INPUT_QTY" ItemID="DELI_QTY"   runat="server" DataIndex="MAT_INPUT_QTY" Width="80" Align="Right" Format="#,##0"/> <%--Text="납품수량"--%>  
                                <ext:Column ID="INSPECT_YN"          ItemID="INSPECT_YN" runat="server" DataIndex="INSPECT_YN"    Width="70" Align="Center"/>               <%--Text="유/무검사"--%> 
                                <ext:Column ID="VENDNM"              ItemID="VENDNM"     runat="server" DataIndex="VENDNM"        Width="150" Align="Left"/>              <%--Text="업체명"--%>      
                                <ext:Column ID="CHECK_CERT"          ItemID="CHECK_CERT" runat="server" DataIndex="CHECK_CERT"    Width="70" Align="Center"/>               <%--Text="관리대상"--%>  
                                <ext:Column ID="ISOK"                ItemID="ISOK"       runat="server" DataIndex="ISOK"          Width="70" Align="Center"/>               <%--Text="입력여부"--%>  
