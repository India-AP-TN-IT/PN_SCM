...
/* 
 * 프로그램명 : 자재 PART NO 정보 (구.VM3260)
 * 설      명 : 자재관리 > 발주관리 > 자재 PART NO 정보
 * 최초작성자 : 이명희
 * 최초작성일 : 2014-09-22
 * 수정  내용 :
 *  
...
{
    public partial class SRM_MM31005 : BasePage
    {
        private string pakageName = "APG_SRM_MM31005";
        ...
        public void Save(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                (
                   "CORCD", "BIZCD", "PURC_ORG", "VENDCD", "PARTNO", "SCM_CLS_YN"
                );
                ...
                for (int i = 0; i < parameters.Length; i++)
                {
                    ...
                    (
                        ...
                        , parameters[i]["PARTNO"]
                        , parameters[i]["SCM_CLS_YN"].ToString().Equals("true") ? "Y" : "N"
                    );
                }
        ...
        [DirectMethod]
        public void MakePopUp(String[] arr)
        {
            HEParameterSet param = new HEParameterSet();
            param.Add("CORCD", arr[0]);
            param.Add("BIZCD", arr[1]);
            param.Add("PARTNO", arr[2]);
            param.Add("PARTNM", arr[3]);
            Util.UserPopup((BasePage)this.Form.Parent.Page, "../SRM_MM/SRM_MM31005P1.aspx", param, "HELP_MM31005P1", "Popup", 800, 600);            
        }
    }
}
