<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM32001P1.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM32001P1" %>
...
<body>
    <form id="SRM_MM32001P1" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM32001P1" runat="server" Cls="search_area_title_name" />
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column            ID="PONO" ItemID="PONO" runat="server" DataIndex="PONO" Width="110"  Align="center"  />
                                <ext:Column            ID="DELI_DATE" ItemID="DELI_DATE" runat="server" DataIndex="DELI_DATE" Width="80"  Align="center" />
                                <ext:Column            ID="STR_LOCNM" ItemID="STR_LOCNM" runat="server" DataIndex="STR_LOCNM" Width="80"  Align="left"/>
                                ...
                                <ext:Column            ID="UPDATE_ID" ItemID="UPDATE_ID3" runat="server" DataIndex="UPDATE_ID" Width="90"  Align="left" />
                            </Columns>
                        </ColumnModel>
