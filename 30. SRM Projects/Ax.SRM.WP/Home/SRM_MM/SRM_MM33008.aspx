<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM33008.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM33008" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var CellClick = function (grid, obj1, cellIndex, obj2, obj3, rowIndex, obj4) {
            ...
            var rcvYear = grid.getStore().getAt(rowIndex).data["RCV_YEAR"];
            var rcvNo = grid.getStore().getAt(rowIndex).data["RCV_NO"];

            //loadmask = new Ext.LoadMask(target, { msg: "Please wait..." + rcvYear + ".." + rcvNo + ".." + rcvType });
...
<body>
    <form id="SRM_MM33008" runat="server">
    <ext:ResourceManager ID="ResourceManager1" runat="server">
        <Listeners>
            <DocumentReady Handler="ExtDocumentReady();" />
        </Listeners>
    </ext:ResourceManager>
    <ext:TextField ID="ACC_RCV_YEAR" runat="server" Hidden="true"></ext:TextField>
    <ext:TextField ID="ACC_RCV_NO" runat="server" Hidden="true"></ext:TextField>
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM33008" runat="server" Cls="search_area_title_name" /><%--Text="월납품현황" --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <Model>
                                    <ext:Model ID="GridModel1" runat="server">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="BKTXT"/>
                                            <ext:ModelField Name="INVOICE_DATE"/>
                                            <ext:ModelField Name="RCV_YEAR"/>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="INVOICE_DATE" ItemID="INVOICE_DATE" runat="server" DataIndex="INVOICE_DATE" Width="100" Align="Center" Text="Invoice Date"/>  <%--Text="전기일자"--%> 
                                ...
                                <ext:Column ID="BKTXT" ItemID="SAP_VENDOR_INVNO" runat="server" DataIndex="BKTXT" Width="120" Align="Center" Text="SAP Vendor Invoice"/>  <%--Text="업체계산서번호"--%> 
                                <ext:Column ID="RCV_YEAR" ItemID="RCV_YEAR" runat="server" DataIndex="RCV_YEAR" Width="0" Align="Center" Visible="false"/>  <%--Text="업체계산서번호"--%>
                                <ext:Column ID="RCV_NO" ItemID="RCV_NO" runat="server" DataIndex="RCV_NO" Width="120" Align="Center" Text="Invoice Doc. No"/>  <%--Text="업체계산서번호"--%> 
                            </Columns>
                        </ColumnModel>
                            ...
                            <ext:GridPanel ID="Grid02" runat="server" Hidden="false" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <ColumnModel ID="ColumnModel2" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column ID="RCV_NO_2" ItemID="RCV_NO" runat="server" DataIndex="RCV_NO" Width="120" Align="Center" /><%--Text="송장문서번호"--%>
                                        ...
                                        <ext:NumberColumn ID="PART_UCOST_2" ItemID="PART_UCOST" runat="server" DataIndex="PART_UCOST" Width="100" Align="Right" Format="#,##0.##" Sortable="true"/><%--Text="부품단가"--%>
                                        ...
                                        <ext:Column ID="DELI_NOTE_2" ItemID="DELI_NOTE" runat="server" DataIndex="DELI_NOTE" Width="100" Align="Left" Text="Delivery Note"/><%--Text="Delivery Note"--%>
                                        <ext:Column ID="INVOICE_NO_2" ItemID="INVOICE_NO" runat="server" DataIndex="INVOICE_NO" Width="140" Align="Left" Text="SCM Vendor Invoice"/><%--Text="Invoice"--%>
                            ...
                            <ext:GridPanel ID="Grid03" runat="server" Hidden="true" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <ColumnModel ID="ColumnModel3" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column ID="RCV_NO_3" ItemID="RCV_NO" runat="server" DataIndex="RCV_NO" Width="120" Align="Center" /><%--Text="송장문서번호"--%>
                            ...
                            <ext:GridPanel ID="Grid04" runat="server" Hidden="true" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <ColumnModel ID="ColumnModel4" runat="server">
                                    <Columns>
                                        ...
                                        <ext:Column ID="RCV_NO_4" ItemID="RCV_NO" runat="server" DataIndex="RCV_NO" Width="120" Align="Center" /><%--Text="송장문서번호"--%>
