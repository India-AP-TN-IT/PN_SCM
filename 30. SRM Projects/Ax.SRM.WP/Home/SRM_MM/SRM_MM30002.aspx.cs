...
{
    public partial class SRM_MM30002 : BasePage
    {
        private string pakageName = "APG_SRM_MM30002";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!X.IsAjaxRequest)
                {
                    ...
                    this.cbo01_PURC_ORG.SelectedItem.Value = "1A1100"; //내수 고정
                    this.cbo01_PURC_ORG.UpdateSelectedItems(); //꼭 해줘야한다.
                    this.cbo01_PURC_ORG.ReadOnly = true;
        ...
        private DataSet getDataSet()
        {
            ...
            param.Add("CUST_COR", this.cdx01_CUSTCD.Value);
