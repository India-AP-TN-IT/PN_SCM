<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM32003P1.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM32003P1" %>
...
<body>
    <form id="SRM_MM32003P1" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM32003P1" runat="server" Cls="search_area_title_name"/>
