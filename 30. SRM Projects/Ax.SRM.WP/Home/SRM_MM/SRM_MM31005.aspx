<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM31005.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM31005" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var linkClick = function (store, rowIndex, cellIndex) {
            ...
            var param1 = new Array(store.getAt(rowIndex).data["CORCD"], store.getAt(rowIndex).data["BIZCD"], store.getAt(rowIndex).data["PARTNO"], store.getAt(rowIndex).data["PARTNM"]);
            App.direct.MakePopUp(param1); // P : 발주량, D : 납품량
        };

    </script>
</head>
<body>
    <form id="SRM_MM31005" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM31005" runat="server" Cls="search_area_title_name" /><%--Text="자재 PART NO 정보" />--%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <Model>
                                    <ext:Model ID="GridModel1" runat="server">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="MEDI_CASE_CD" />
                                            <ext:ModelField Name="MEDI_PACK_SIZE_DESC" />
                                            <ext:ModelField Name="BEG_DATE" />
                                            <ext:ModelField Name="END_DATE" />
                                            <ext:ModelField Name="JOB_TYPENM" />
                                            <ext:ModelField Name="MAT_TYPENM" />
                                            <ext:ModelField Name="ESTI_CLASSNM" />
                                            <ext:ModelField Name="SOURCING_DIVNM" />
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="VENDORCD" ItemID="VEND" runat="server" DataIndex="VENDORCD" Width="70" Align="Center" /><%--Text="거래처코드"--%>
                                <ext:Column ID="VENDORNM" ItemID="VENDNM" runat="server" DataIndex="VENDORNM" Width="100" Align="Left" /><%--Text="거래처명"--%>
                                ...
                                <ext:Column ID="MEDI_CASE_CD" ItemID="MEDI_CASE_CD" runat="server" DataIndex="MEDI_CASE_CD" Width="80" Align="Center" /><%--Text="중포장 코드"--%>
                                <ext:Column ID="MEDI_PACK_SIZE_DESC" ItemID="MEDI_PACK_SIZE" runat="server" DataIndex="MEDI_PACK_SIZE_DESC" Width="90" Align="Center" /><%--Text="중포장사이즈"--%>
                                ...
                                <ext:Column ID="JOB_TYPENM" ItemID="JOB_TYPE" runat="server" DataIndex="JOB_TYPENM" Width="80" Align="Center" /><%--Text="업무유형"  --%>
                                <ext:CheckColumn ID ="SCM_CLS_YN" ItemID="SCM_CLS_YN" runat="server" DataIndex="SCM_CLS_YN" Width="80" Align ="Center" StopSelection="false" 
                                    Editable="true" MenuDisabled="true" Sortable="false" Selectable="true" Hidden="true"><%--Text="사급직납마감대상"--%>
                                </ext:CheckColumn>                                    
                                <ext:Column ID="ORIGINDOCNO" ItemID="ORIGINDOCNO" runat="server" DataIndex="ORIGINDOCNO" Width="100" Align="Center" /><%--Text="원산지 증명번호"  --%>
                                <ext:Column ID="HSCD" ItemID="HSCD" runat="server" DataIndex="HSCD" Width="90" Align="Left" Text="HS CODE" Hidden="true"><%--Text="HS CODE"  --%>
                                    <Renderer Fn="linkRenderer"/>
                                </ext:Column>
                                <ext:Column ID="MAT_GRPNM" ItemID="MAT_GRP" runat="server" DataIndex="MAT_GRPNM" Width="80" Align="Left"  Hidden="true"/><%--Text="자재그룹"  --%>
                                <ext:Column ID="ESTI_CLASSNM" ItemID="ESTI_CLASS" runat="server" DataIndex="ESTI_CLASSNM" Width="80" Align="Left" /><%--Text="평가클래스"  --%>
                                <ext:Column ID="SOURCING_DIVNM" ItemID="SOURCING_DIV" runat="server" DataIndex="SOURCING_DIVNM" Width="80" Align="Left" /><%--Text="소싱그룹"  --%>
