<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM36006.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM36006" %>
...
<body>
    <form id="SCM_MM33003" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SCM_MM33004" runat="server" Cls="search_area_title_name" /><%--Text="단가정산 조회" />--%>
                        ...
                        <tr>
                            ...
                            <td colspan="8">
                                <ext:RadioGroup ID="RadioGroup1" runat="server" Width="200" Cls="inputText" ColumnsWidths="100,100">
                                    <Items>
                                        <ext:Radio ID="rdo01_OPT11" Cls="inputText" runat="server" InputValue="1" Visible="false" />
                                        <ext:Radio ID="rdo01_OPT12" Cls="inputText" runat="server" InputValue="2" Checked="true" />
                                    </Items>       
                                    <Listeners>
