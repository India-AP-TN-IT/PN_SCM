<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM26001P2.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM26001P2" %>
...
<body>
    <form id="SRM_MM26001P2" runat="server">
    ...
    <ext:TextField ID="tCORCD" runat="server" Hidden="true" />
    <ext:TextField ID="tBIZCD" runat="server" Hidden="true" />
    <ext:TextField ID="tCUSTCD" runat="server" Hidden="true" />
    <ext:TextField ID="tREQ_DATE" runat="server" Hidden="true" />
    <ext:TextField ID="tDIV" runat="server" Hidden="true" /> 
    <ext:TextField ID="tPARTNO" runat="server" Hidden="true" /> 
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM26001P2" runat="server" Cls="search_area_title_name" />
                    <ext:Panel ID="ButtonPanel" runat="server"  StyleSpec="width:100%"  Height="30" Cls="search_area_title_btn">
                        <Items>
                            <ext:Button ID="btn01_DELETE" runat="server" TextAlign="Center" Cls="mg_r4" Width="72px">
                                <DirectEvents>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <Model>
                                    <ext:Model ID="GridModel1" runat="server">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="SAPIF_RSLT"/>   
                                        </Fields>
                                    </ext:Model>
                                </Model>
                                <Listeners>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:NumberColumn      ID="REQ_QTY"        ItemID="FORE_QTY"         runat="server" DataIndex="REQ_QTY"    Width="80"  Align="Right"  Format="#,##0" />
                                ...
                                <ext:Column            ID="SAPIF_RSLT" ItemID="SAPIF_RSLT" runat="server" DataIndex="SAPIF_RSLT" MinWidth="80" Flex="1"  Align="Left" />
                            </Columns>
                        </ColumnModel>
