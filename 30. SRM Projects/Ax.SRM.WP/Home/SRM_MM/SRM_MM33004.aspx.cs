...
{
    public partial class SRM_MM33004 : BasePage
    {
        ...
        private void Print()
        {
            try
            {
                ...
                if (source1 != null && source1.Tables[0].Rows.Count > 0)
                {
                    ...
                    report.ReportName = "1000/SRM_MM/SRM_MM33004_1";  // 리포트ID 경로포함 ( 확장자 .reb 는 제외 )  ** 주의 ** 리포트 파일은 디자인후 속성창의 빌드작업에 포함리소스로 지정하도록 한다.
                ...
                if (source2 != null && source2.Tables[0].Rows.Count > 0)
                {
                    ...
                    HERexReport report = new HERexReport(this.UserInfo.UserID, this.UserInfo.UserName, true);
                    report.ReportName = "1000/SRM_MM/SRM_MM33004_2";  // 리포트ID 경로포함 ( 확장자 .reb 는 제외 )  ** 주의 ** 리포트 파일은 디자인후 속성창의 빌드작업에 포함리소스로 지정하도록 한다.
