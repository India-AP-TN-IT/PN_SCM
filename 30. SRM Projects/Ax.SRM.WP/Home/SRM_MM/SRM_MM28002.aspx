<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM28002.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM28002" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">	    	    
	    ...
	    .x-grid-cell-PROD_DATE DIV,
	    .x-grid-cell-PARTNO7,
	    .x-grid-cell-LOTNOTITLE,
	    .x-grid-cell-MPNO_DATE
	    {	
		    border-width:1px;
		    border-style:solid;
...
<body>
    <form id="SRM_MM28002" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM28002" runat="server" Cls="search_area_title_name" /><%--Text="자재 LOT 정보 등록" />--%>
            ...
            <ext:Label ID="lbl01_MM_MSG003" runat="server" Region="North" Height="25" Cls="grid_area_coment" /><%--Text="반드시 *.xls로 올리세요."--%> 
...
<%--                                    <RenderTpl ID="RenderTpl1" runat="server">
                                ...
                                <ext:Column ID="ASSY_INFO" ItemID="ASSY_INFO" runat="server" ><%--Text="ASS'Y 정보">--%>
                                    <Columns>
                                        <ext:Column ID="PARTNO" ItemID="PARTNO" DataIndex="PARTNO" runat="server" Width="120" Align="Left" Sortable="true"><%--Text="PART NO" --%>
                                            <Editor>
                                                <ext:TextField ID="txt02_PARTNO" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                            </Editor>
                                        </ext:Column>
                                        <ext:Column ID="PARTNO_LOTNO" ItemID="LOTNO" DataIndex="PARTNO_LOTNO" runat="server" MinWidth="120" Align="Left" Flex="1" Sortable="true"><%--Text="LOT NO" --%>
                                            <Editor>
                                                <ext:TextField ID="txt02_PARTNO_LOTNO" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                            </Editor>
                                        </ext:Column> 
                                        <ext:DateColumn ID="PARTNO_DATE" ItemID="PROD_DATE" runat="server" DataIndex="PARTNO_DATE" Width="100" Align="Center" Sortable="true" Format="yyyy-MM-dd"><%--생산일자--%>
                                            <Editor>
                                                <ext:DateField ID="dte02_PARTNO_DATE" runat="server"  SelectOnFocus="true"  > 
                                                </ext:DateField>
                                            </Editor>
                                        </ext:DateColumn>
                                    </Columns>
                                ...
                                <ext:Column ID="MP_INFO" ItemID="MP_INFO" runat="server" ><%--Text="SUB 정보">--%>
                                    <Columns>
                                        <ext:Column ID="MPNO" ItemID="PARTNO7" DataIndex="MPNO" runat="server" Width="120" Align="Left" Sortable="true"><%--Text="PART NO" --%>
                                            <Editor>
                                                <ext:TextField ID="txt02_MPNO" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                            </Editor>
                                        </ext:Column>
                                        <ext:Column ID="MPNO_LOTNO" ItemID="LOTNOTITLE" DataIndex="MPNO_LOTNO" runat="server" MinWidth="120" Align="Left" Flex="1" Sortable="true"><%--Text="LOT NO" --%>
                                            <Editor>
                                                <ext:TextField ID="txt02_MPNO_LOTNO" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                            </Editor>
                                        </ext:Column> 
                                        <ext:DateColumn ID="MPNO_DATE" ItemID="MPNO_DATE" runat="server" DataIndex="MPNO_DATE" Width="100" Align="Center" Sortable="true"  Format="yyyy-MM-dd"><%--생산일자--%>
                                            <Editor>
                                                <ext:DateField ID="dte02_MPNO_DATE" runat="server"  SelectOnFocus="true"  > 
                                                </ext:DateField>
                                            </Editor>
                                        </ext:DateColumn>
                                    </Columns>
                    ...
                    <ext:GridPanel ID="Grid02" runat="server" Visible="false" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel2" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="E_PARTNO" ItemID="ASSY_PARTNO" runat="server" DataIndex="PARTNO" Width="50" Align="Center" />
                                <ext:Column ID="E_PARTNO_LOTNO" ItemID="ASSY_LOTNO" runat="server" DataIndex="PARTNO_LOTNO" Width="50" Align="Center" />
                                <ext:Column ID="E_PARTNO_DATE" ItemID="ASSY_PROD_DATE" runat="server" DataIndex="PARTNO_DATE" Width="100" Align="Left" />  
                                <ext:Column ID="E_MPNO" ItemID="SUB_MPNO" runat="server" DataIndex="MPNO" Width="120" Align="Left" />
                                <ext:Column ID="E_MPNO_LOTNO" ItemID="MPNO_LOTNO" runat="server" DataIndex="MPNO_LOTNO" Width="180" Align="Left" />
                                <ext:Column ID="E_MPNO_DATE" ItemID="MPNO_PROD_DATE" runat="server" DataIndex="MPNO_DATE" Width="140" Align="Center" />
                                <%--<ext:DateColumn ID="E_INSERT_DATE" ItemID="INSERT_DATE" Format="yyyy-MM-dd HH:mm:ss" runat="server" DataIndex="INSERT_DATE" Width="130" Align="Center"/>--%><%--Text="최초등록일시"    --%>  
                                <%--<ext:Column ID="E_INSERT_ID" ItemID="INSERT_ID" runat="server" DataIndex="INSERT_ID" Width="80" Align="Center"/>--%><%--Text="최초등록자"    --%>  
                                <%--<ext:DateColumn ID="E_UPDATE_DATE" ItemID="FNLUPDATEDTTM" Format="yyyy-MM-dd HH:mm:ss" runat="server" DataIndex="UPDATE_DATE" Width="130" Align="Center"/>--%><%--Text="최종수정일시"    --%>  
                                <%--<ext:Column ID="E_UPDATE_ID" ItemID="FNLUPDATEID" runat="server" DataIndex="UPDATE_ID" Width="80" Align="Center"/>--%><%--Text="최종수정자"    --%>                            
                            </Columns>
                        </ColumnModel>
