<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MM31006P2.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MM.SRM_MM31006P2" %>
...
<body>
    <form id="SRM_MM31006P2" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MM31006P2" runat="server" Cls="search_area_title_name" />
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="ARRIVE_INFO" runat="server" >
                                    <Columns>
                                        <ext:Column            ID="GRN_DATE" ItemID="ARRIVE_DATE" runat="server" DataIndex="GRN_DATE" Width="80"  Align="center" />
                                        <ext:Column            ID="GRN_NO" ItemID="ARRIVENO" runat="server" DataIndex="GRN_NO" Width="130"  Align="center" />
                                        <ext:NumberColumn      ID="GRN_QTY"        ItemID="ARRIV_QTY"         runat="server" DataIndex="GRN_QTY"    Width="70"  Align="Right"  Format="#,##0.###" />
                                        <ext:Column            ID="MOVE_TYPE" ItemID="MOVE_TYPE" runat="server" DataIndex="MOVE_TYPE" Width="80"  Align="center" />
                                    </Columns>
                                </ext:Column>
                                ...
                                <ext:Column ID="DELI_INFO" runat="server">
                                    <Columns>
                                        <ext:Column            ID="DELI_DATE" ItemID="DELI_DATE" runat="server" DataIndex="DELI_DATE" Width="80"  Align="center" />
                                        <ext:Column            ID="DELI_CNT" ItemID="DELI_CNT" runat="server" DataIndex="DELI_CNT" Width="60"  Align="center" />
