...
{
    public partial class SRM_ALC30007 : BasePage
    {
        private string pakageName = "APG_SRM_ALC30007";
        ...
        private DataSet getReportDataSet()
        {
            ...
            param.Add("YMD", ((DateTime)this.df01_YYMM.Value).ToString("yyyyMM"));
        ...
        private void Print()
        {
            try
            {
                ...
                report.ReportName = "1000/SRM_ALC/SRM_ALC30007";  // /Report 폴더의하의 경로 ( 확장자 .reb 는 제외 ) / 리포트 파일은 법인코드 경로 아래에 모아두도록 함
        ...
        public bool IsQueryValidation()
        {
            ...
            else if (this.df01_YYMM.IsEmpty)
            {
                this.MsgCodeAlert_ShowFormat("SRMMP00-0023", "df01_QUT_DATE", lbl01_YYMM.Text);
                return false;
            }
            return true;
        }
