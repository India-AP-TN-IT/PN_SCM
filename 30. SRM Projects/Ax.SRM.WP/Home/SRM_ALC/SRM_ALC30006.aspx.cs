...
{
    public partial class SRM_ALC30006 : BasePage
    {
        private string pakageName = "APG_SRM_ALC30006";
        ...
        private void Print()
        {
            try
            {
                ...
                report.ReportName = "1000/SRM_ALC/SRM_ALC30006";  // /Report 폴더의하의 경로 ( 확장자 .reb 는 제외 ) / 리포트 파일은 법인코드 경로 아래에 모아두도록 함
