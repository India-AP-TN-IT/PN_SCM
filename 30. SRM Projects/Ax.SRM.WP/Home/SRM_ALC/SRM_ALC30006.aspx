<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_ALC30006.aspx.cs" Inherits="Ax.EP.WP.Home.SRM_ALC.SRM_ALC30006" %>
...
<body>
    <form id="SRM_ALC30006" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" >
                <Items>
                    <ext:Label ID="lbl01_SRM_ALC30006" runat="server" Cls="search_area_title_name" /><%--Text="일별 집계 출력" />--%>
