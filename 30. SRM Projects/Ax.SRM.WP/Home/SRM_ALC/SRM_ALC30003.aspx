<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_ALC30003.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_ALC.SRM_ALC30003" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function dataRefresh() {
            if (App.cdx01_VENDCD_OBJECTID.getValue() != "") App.ButtonSearch.fireEvent('click');
        }
        ...
        var fn_DivsionComboChange = function () {
            App.direct.SetDivsionComboChange();
        };
        ...
        //function Search() {
            //clearTimeout(auto);
            //auto = setTimeout("App.direct.SearchTime();", 10000);

            //auto = setTimeout("App.direct.SearchTime();", 3000);
        //}
...
<body>
    <form id="SRM_ALC30003" runat="server">
    ...
    <ext:TextField ID="txt01_CHASU_QTY" runat="server" Hidden="true" ></ext:TextField> 
    ...
    <ext:TextField ID="txtRead" runat="server" Hidden="true" ></ext:TextField> 
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_ALC30003" runat="server" Cls="search_area_title_name" Text="주간 소요량" />
                ...
                <Content>
                    <table style="height:0px;">
                        ...
                        <tr>
                            ...
                            <th>
                                <ext:Label ID="lbl01_DIVISION" runat="server" />
                            </th>
                            <td>
                                <ext:SelectBox ID="cbo01_DIVISION" runat="server"  Mode="Local" ForceSelection="true"
                                    ...
                                    <Listeners>
                                        <Select Fn="fn_DivsionComboChange"></Select>
                                    </Listeners>
                                </ext:SelectBox>
                            </td>
                            <th>
                            ...
                            <td colspan="3">
                                <ext:SelectBox ID="cbo01_PLANT_GB" runat="server"  Mode="Local" ForceSelection="true"
                                    ...
                                    <Listeners>
                                        <Change Fn="fn_PlantComboChange"></Change>
                                    </Listeners>
                                </ext:SelectBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <ext:TextField ID="txt02_CHASU" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" MaskRe="/[0-9\,]/"/>
                            </td>
                             <th>
                                <ext:Label ID="lbl01_MAX_SEQ" runat="server"  Text="Max SEQ"/><%--Text="Max SEQ"--%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_MAX_SEQ" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" MaskRe="/[0-9\,]/"/>
                            </td>
                        </tr> 
                    </table>
                </Content>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="TIME_R" ItemID="TIME_R" runat="server" DataIndex="TIME_R" Width="60" Align="Center" Hidden="true" />  <%--Text="TIME"--%> 
