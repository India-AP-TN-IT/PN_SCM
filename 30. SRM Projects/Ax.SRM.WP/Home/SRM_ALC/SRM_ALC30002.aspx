<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_ALC30002.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_ALC.SRM_ALC30002" %>
...
<body>
    <form id="SRM_ALC30002" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_ALC30002" runat="server" Cls="search_area_title_name" Text="주간 소요량" />
