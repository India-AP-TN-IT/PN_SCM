<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZSRM_ALC30001.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_ALC.ZSRM_ALC30001" %>
...
<body>
    <form id="ZSRM_ALC30001" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_ZSRM_ALC30001" runat="server" Cls="search_area_title_name" Text="ALC 수신현황 조회" />
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="CP" ItemID="CP" runat="server" DataIndex="CP" Width="50" Align="Center" Text="CP" /> 
                                <ext:Column ID="CS" ItemID="CS" runat="server" DataIndex="CS" Width="50" Align="Center" Text="CS" /> 
                                <ext:Column ID="BZ" ItemID="BZ" runat="server" DataIndex="BZ" Width="50" Align="Center" Text="BZ" /> 
                                <ext:Column ID="CU" ItemID="CU" runat="server" DataIndex="CU" Width="50" Align="Center" Text="CU" /> 
                                <ext:Column ID="LOT_DTFL" ItemID="LOT_DTFL" runat="server" DataIndex="LOT_DTFL" Width="80" Align="Center" Text="LOT_DTFL" /> 
                                <ext:Column ID="LOT_DTFR" ItemID="LOT_DTFR" runat="server" DataIndex="LOT_DTFR" Width="80" Align="Center" Text="LOT_DTFR" /> 
                                <ext:Column ID="LOT_DTRL" ItemID="LOT_DTRL" runat="server" DataIndex="LOT_DTRL" Width="80" Align="Center" Text="LOT_DTRL" /> 
                                <ext:Column ID="LOT_DTRR" ItemID="LOT_DTRR" runat="server" DataIndex="LOT_DTRR" Width="80" Align="Center" Text="LOT_DTRR" /> 
                                <ext:Column ID="LOT_CP" ItemID="LOT_CP" runat="server" DataIndex="LOT_CP" Width="80" Align="Center" Text="LOT_CP" /> 
                                <ext:Column ID="LOT_CS" ItemID="LOT_CS" runat="server" DataIndex="LOT_CS" Width="80" Align="Center" Text="LOT_CS" /> 
                                <ext:Column ID="LOT_BZ" ItemID="LOT_BZ" runat="server" DataIndex="LOT_BZ" Width="80" Align="Center" Text="LOT_BZ" /> 
                                <ext:Column ID="LOT_CU" ItemID="LOT_CU" runat="server" DataIndex="LOT_CU" Width="80" Align="Center" Text="LOT_CU" /> 
                            </Columns>
                        </ColumnModel>
