<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_VM20003P1.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_VM.SRM_VM20003P1" %>
...
<body>
    <form id="SRM_VM20003P1" runat="server">
    ...
    <ext:TextField ID="BIZCD" runat="server" Hidden="true"></ext:TextField>
    <ext:TextField ID="VENDCD" runat="server" Hidden="true"></ext:TextField>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_VM20003P1" runat="server" Text="업체 조회" />
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_T1_VENDCD" runat="server" Text="업체코드"  Width="110" />
                            </th>
                            <td>
                                <ext:TextField ID="txt01_SQ_VENDCD" runat="server" Width="120">
                                    <Listeners>
                                        <Change Handler="App.txt01_SQ_VENDNM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl01_VENDNM" runat="server" Text="업체명" Width="110" />
                            </th>
                            <td>
                                <ext:TextField ID="txt01_SQ_VENDNM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="T1_VENDCD" ItemID="T1_VENDCD"   runat="server" Text="업체코드" DataIndex="SQ_VENDCD" Width="120" Align="Center" />
                                <ext:Column ID="SQ_VENDNM" ItemID="VENDNM" runat="server" Text="업체명" DataIndex="SQ_VENDNM" fLEX="1" MinWidth="150" Align="Left" />
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_SQ_VENDCD">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_SQ_VENDNM">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
