<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_VM20002.aspx.cs" Inherits="Ax.EP.WP.Home.SRM_VM.SRM_VM20002" %>
...
<head id="Head1" runat="server">
    ...
    .x-grid-cell-TRANS_VENDNM1 DIV,	    
	    ...
	    .x-grid-cell-DEGREE DIV,
	    .x-grid-cell-PARTNO3 DIV,
	    .x-grid-cell-PROCNM DIV,
	    .x-grid-cell-COOPER_NM2 DIV,
	    .x-grid-cell-ADDR DIV,
	    .x-grid-cell-CHR_TEL DIV,
	    .x-grid-cell-CHARGENM DIV,
	    .x-grid-cell-GRADENM DIV,
	    .x-grid-cell-F_CORP DIV,
	    .x-grid-cell-S_CORP DIV,
	    .x-grid-cell-SQ_YN4 DIV,
    ...
    <script type="text/javascript">
        ...
        function UI_Resize() {
            ...
            App.InputPanel.setHeight(App.pnl01_GEN.getHeight() +
                                    ...
                                    App.pnl01_ITEM_INFO.getHeight() +                                                                        
                                    App.pnl01_AFF_GRP.getHeight() +
                                    App.pnl01_ABR_GRP.getHeight() +                                                                                                            
                                    App.pnl01_ETC.getHeight() +
                                    App.pnl01_FAC.getHeight() +
                                    App.pnl01_UPLOAD.getHeight() +                                    
                                    App.pnl01_SEAL_IMAGE.getHeight() +150);
        }

        var ChecVendCD = function () {
        ...
        var addNewRow = function (grid) {
            ...
            else if (grid.id == "Grid06") {
                //3레코드까지만 신규 추가 가능
                if (grid.store.getCount() >= 100) {
                    App.direct.MsgCodeAlert("SRMVM-0018"); //최대 3건까지만 등록할 수 있습니다.
                    return;
                }
                //                r = Ext.ModelManager.create({
                //                    DEGREE: '',
        ...
        var AfterEdit = function (rowEditor, e) {
            ...
            if (e.grid.id == "Grid06") {
                if (e.column.dataIndex != "CHECK_VALUE") {
                    ...
                    e.grid.getStore().getAt(e.rowIdx).dirty = true;
                } else {
                    for (var i = 0; i < e.grid.getStore().count(); i++) {
                        if (e.grid.getStore().getAt(e.rowIdx).data["SUB_VENDNM"] == e.grid.getStore().getAt(i).data["SUB_VENDNM"]) {
                            e.grid.getStore().getAt(i).set("CHECK_VALUE", e.grid.getStore().getAt(e.rowIdx).data["CHECK_VALUE"]);
                            e.grid.getStore().getAt(e.rowIdx).dirty = e.grid.getStore().getAt(e.rowIdx).data["CHECK_VALUE"];
                        }
                    }
                }
            }
            else if (e.grid.id == "GridPanel77") {
                if (e.column.dataIndex != "CHECK_VALUE") {
                    e.grid.getStore().getAt(e.rowIdx).set("CHECK_VALUE", false);
                    e.grid.getStore().getAt(e.rowIdx).dirty = true;
                } else {
        ...
        function fn_GridSetValues(popupID, objectID, typeNM, typeCD, record) {
            ...
            // 코드명만 다르게 처리(코드 + NAME) 
            if (App.CodeColName.getValue() == "PARTNO") textName = "PARTNM";
            
            // 코드처리는 동일 (코드 및 name이 같이 들어가는 경우에만 사용
            if (App.CodeColName.getValue() == "PARTNO")
        ...
        var PopupHandler_File = function (editor, command, row, rowIndex, colIndex) {
            //var grd = editor.grid;
            var grd = editor.ownerCt.grid;
            if (grd.getStore().getAt(rowIndex).data.R_ID == '') {
                alert('현재 저장된 파일이 아닙니다.');
            } else {
                App.direct.SeeFile(grd.getStore().getAt(rowIndex).data.R_ID);
            }
        }

        var PopUpFire = function () {            
            if (App.CodeColName.getValue() == "PARTNO") App.btn02_PARTNO.fireEvent('click');            
        }
        ...
        var downloadHelp = function (fname) {
...
//        var upload = function () {
//            if (confirm('Do you want save?') == true){APP.MultiUpload1.startUpload();}
//        }
...
//        };
        ...
        var removeUpload = function (btn) {
            ...
            if (App.cdx01_VENDCD_OBJECTID.getValue() == "") {
                ...
                Ext.Msg.confirm("알림", "선택된 행을 삭제 하시겠습니까?", function (btn) {
                    if (btn == 'yes') {                        
...
<body>
    <form id="SRM_VM20001" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            ...
            <ext:Panel ID="TitlePanel" Region="North" runat="server" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_VM20002" runat="server" Cls="search_area_title_name"/><%--Text="업체 기본현황 작성" />--%>
                    ...
                    <table style="height:0px;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                OnAfterValidation="cdx01_PARTNO_AfterValidation"  />
                            </td>
                        </tr>                        
                    </table>
                </Content>
            ...
            <ext:Panel ID="InputPanel" runat="server" Width="1500" Height="2630" Region="Center" Scrollable="Both" StyleSpec="overflow:auto;" > 
                <Items>
                        ...
                        <Content>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <ext:Label ID="lbl01_UP_VENDCD" runat="server" /><%--Text="상위업체코드" />--%>
                                    </th>  
                                    <td>
                                        <epc:EPCodeBox ID="cdx01_UP_VEND" runat="server" HelperID="HELP_VENDCD_FREE" PopupMode="Search" PopupType="HelpWindow"
                                                OnBeforeDirectButtonClick="cdx01_UP_VEND_BeforeDirectButtonClick"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ext:TextField ID="txt01_VENDNM"  runat="server" Width="350" Cls="inputText" />
                                    </td>                                    
                                </tr>
                                <tr>
                    ...
                    <%--2.대표자정보--%>
                    <ext:Label ID="lbl01_TIT_REP"  runat="server"  Cls="bottom_area_title_name" Hidden="true" /> <%--Text="대표자정보"--%>
                    <ext:Panel ID="pnl01_REP" Cls="excel_upload_area_table" runat="server"  StyleSpec="width:1500px !important;"  Hidden="true">
                        <Content>
                            <table>
                                <colgroup>
                                    <col style="width: 150px;" />
                                ...
                                <tr>
                                    ...
                                    <td rowspan="5" style="padding:3px 10px 3px 10px !important;">
                                        <ext:Panel ID="ImagePanel" runat="server"  Width="150px" Border="False" BodyStyle="overflow-y:auto;" Height="160px">
                                            <Items>
                                                <ext:Image ID="img01_REP_PHOTO" runat="server" Align="Middle" >
                    ...
                    <ext:Panel ID="pnl01_EMP_GRP" runat="server" Width="250" StyleSpec="margin-right:10px; float:left;" Hidden="true" >
                        <Items>
                    ...
                    <ext:Panel ID="pnl01_LAB_GRP" runat="server" Width="300"  StyleSpec="margin-right:10px; float:left;"  Hidden="true">
                        <Items>
                    ...
                    <ext:Panel ID="pnl01_QUAL_GRP" runat="server" Width="930"  Hidden="true">
                        <Items>
                   ...
                   <%--14.SQ업종별 HKMC 1차사 거래 현황--%>                    
                    ...
                    <%--6.서연이화 거래 품목정보(2차~4차 협력사 현황)--%>
                    <ext:Panel ID="pnl01_ITEM_INFO" runat="server" Region="North" Height="528px" StyleSpec="width:1500px !important;">
                       <Content>                        
                            <%--17.1. 주요설비현황(생산설비)--%>                
                            <ext:Panel ID="Panel1" runat="server" Region="North" Height="24" Hidden="false" >
                                <Items> 
                                    <ext:Panel ID="Panel2" runat="server" StyleSpec="margin-right:10px; float:left;" Width="500" Hidden="false">
                                        <Items>
                                            <ext:Label ID="lbl01_TIT_TRADE_ITEMS" runat="server" Cls="bottom_area_title_name2" Width="300px" Text="서연이화 거래 품목정보(2차~4차 협력사 현황)"/>
                                        </Items>
                                    </ext:Panel>
                                    <ext:Panel ID="Panel3" runat="server" Width="897" Hidden="false" Cls="bottom_area_btn" >
                                        <Items>
                                            
                                            <ext:FieldContainer ID="FieldContainer3" runat="server" Width="410" MinWidth="410" Flex="1" MsgTarget="Side" Layout="TableLayout">
                                                <Items>
                                            <ext:Label ID="lbl01_EXCEL" runat="server" Text="Excel Upload"/><%--Text="Excel Upload" />--%>
                                            <ext:FileUploadField ID="fud02_FILEID1" runat="server" Cls="inputText" ButtonText="Browser" Width="362" />
                                            <ext:Panel ID="ButtonPanel2" runat="server"  StyleSpec="width:100%;"  Height="30" Width ="81">
                                                <Items>
                                                    <%-- 엑셀 파일 업로드 버튼 --%>
                                                </Items>
                                            </ext:Panel>
                                            <ext:Button ID="btn01_DOWN" runat="server" TextAlign="Center" Text="DownLoad Form" StyleSpec="margin-right:5px;"><%--Text="양식다운로드" >--%>
                                                <Listeners>
                                                    <Click Handler="downloadHelp('SUB KD 협력사.xlsx')" />
                                                </Listeners> 
                                            </ext:Button>  
                                            <ext:Button ID="btn01_EXCEL" runat="server" TextAlign="Center" Text="Excel D/L" StyleSpec="margin-right:5px;"><%--Text="양식다운로드" >--%>
                                                <DirectEvents >
                                                    <Click OnEvent="etc_Button_Click"></Click>
                                                </DirectEvents>
                                            </ext:Button>  
                                            <ext:ImageButton runat="server" ImageUrl="../../images/btn/btn_icon_add.png" Cls="pr5" ID="ImageButton1" StyleSpec="margin-bottom:10px;">
                                                <Listeners>
                                                    <Click Handler = "addNewRow(App.Grid06)" />
                                                </Listeners>
                                            </ext:ImageButton>
                                            <ext:ImageButton runat="server" ImageUrl="../../images/btn/btn_icon_del.png" ID="ImageButton2" StyleSpec="margin-bottom:10px;">
                                                <Listeners>
                                                    <Click Handler = "removeRow(App.Grid06,'ISNEW')" />
                                                </Listeners>
                                            </ext:ImageButton>

                                            <ext:Button ID="btn07_DELETE" runat="server" TextAlign="Center" Cls="mg_r4" Width="72px" StyleSpec="margin-left:10px;margin-bottom:10px;"><%--Text="삭제" >--%>
                                                <DirectEvents>
                                                    <Click OnEvent="etc_Button_Click" >
                                                        <Confirmation ConfirmRequest="true" Title="Confirm" Message="Do you want delete?"></Confirmation>     
                                                        <ExtraParams>
                                                            <ext:Parameter Name="Values" Value="App.Grid06.getRowsValues({dirtyRowsOnly: true})" Mode="Raw" Encode="true" />
                                                        </ExtraParams>
                                                    </Click>
                                                </DirectEvents>
                                            </ext:Button>    
                                           
                                            <ext:Button ID="btn07_SAVE" runat="server" TextAlign="Center" Cls="mg_r4" Width="72px" StyleSpec="margin-bottom:10px;margin-right:0px" ><%--Text="저장" >--%>
                                                <DirectEvents>
                                                    <Click OnEvent="etc_Button_Click" >
                                                        <Confirmation ConfirmRequest="true" Title="Confirm" Message="Do you want save?"></Confirmation>     
                                                        <ExtraParams>
                            ...
                            <ext:Panel ID="Panel19" Region="North" Border="True" runat="server" Cls="grid_area" >
                                <Items> 
                                    <ext:GridPanel ID="Grid06" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display..."  Height="500">
                                        <Store>
                                            <ext:Store ID="Store_Grid06" runat="server" PageSize="50">
                                                <Model>
                                                    <ext:Model ID="Model12" runat="server" Name="ModelGrid06">
                                                        <Fields>
                                                            <%--임의로 생성--%>
                                                            <ext:ModelField Name="NO" /> 
                                                            <ext:ModelField Name="CHECK_VALUE" DefaultValue="false" Type="Boolean" /> <%--선택체크박스--%>
                                                            ...
                                                            <ext:ModelField Name="PROCNM" />
                                                            <ext:ModelField Name="SUB_VENDNM" />
                                                            <ext:ModelField Name="ADDR" />
                                                            <ext:ModelField Name="EMAIL" />
                                                            <ext:ModelField Name="PHONE" />
                                                            <ext:ModelField Name="CHARGER" />
                                                            <ext:ModelField Name="GRADE" />
                                                            <ext:ModelField Name="F_CORP" />                                                            
                                                            <ext:ModelField Name="SQ_YN" /> 
                                                            <ext:ModelField Name="REMARK" />                                                           
                                                            <ext:ModelField Name="R_ID" />                                                               
                                                            <ext:ModelField Name="OBJECT_ID" />
                                        ...
                                        <Plugins>
                                            <ext:BufferedRenderer ID="BufferedRenderer6"  runat="server"/>
                                        ...
                                        <ColumnModel ID="ColumnModel6" runat="server">
                                            <Columns>
                                                <%--NO컬럼--%>
                                                <%--<ext:RowNumbererColumn ID="NO" runat="server" Width="40" Text="No" Align="Center" />--%>   <%-- 자동으로 numbering을 해줌. --%>
                                                <ext:Column ID ="Column5" Text="NO" runat="server" MenuDisabled="true"  Width="40" Align="Center" >
                                                    <Renderer Fn="rendererNo"></Renderer>
                                                </ext:Column>
                                                <%--선택체크박스--%>
                                                <ext:CheckColumn runat="server" ID ="CheckColumn5" Text=""  DataIndex="CHECK_VALUE" Width="35" 
                                                                 StopSelection="false" MenuDisabled="true" Resizable="false" Selectable="true"  Sortable="false"  Editable="true">

                                                        
                                                </ext:CheckColumn>  
                                                <%-- 차수 text editor--%>                                                
                                                <ext:NumberColumn ID="DEGREE" runat="server" DataIndex="DEGREE" Width="50" Align="Right" Format="#,##0">               
                                                    <Editor>
                                                        <ext:NumberField ID="NumberField9" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" AllowBlank="false" />
                                                    </Editor>
                                                </ext:NumberColumn>                                                                                                 
                                                <%-- PARTNO--%>
                                                <ext:Column ID="PARTNO" runat="server" ItemID="PARTNO3" DataIndex="PARTNO" Width="100" Align="Left" Text ="PART NO.">
                                                    <Editor>
                                                ...
                                                <ext:Column ID="PARTNM" ItemID="PARTNMTITLE" runat="server" DataIndex="PARTNM"  MinWidth="180" Align="Left" Text="PART NAME" >                                                    
                                                </ext:Column>

                                                <%-- 공정명 text editor--%>
                                                <ext:Column ID="PROCNM" ItemID="PROCNM" DataIndex="PROCNM" runat="server" Width="80" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField11" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <%-- 협력사명 text editor--%>
                                                <ext:Column ID="SUB_VENDNM" ItemID="COOPER_NM2" DataIndex="SUB_VENDNM" runat="server" Width="150" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField15" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <%-- 담당자 text editor--%>
                                                <ext:Column ID="CHARGER" ItemID="CHARGENM" DataIndex="CHARGER" runat="server" Width="90" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField18" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <ext:Column ID="GRADE" ItemID="GRADENM" DataIndex="GRADE" runat="server" Width="90" Align="center" Text="직함">
                                                    <Editor>
                                                        <ext:TextField ID="TextField24" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <%-- 주소 text editor--%>
                                                <ext:Column ID="ADDR" ItemID="ADDR" DataIndex="ADDR" runat="server" Width="280" Align="Left">
                                                    <Editor>
                                                        <ext:TextField ID="TextField16" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <%-- 연락처 text editor--%>
                                                <ext:Column ID="PHONE" ItemID="CHR_TEL" DataIndex="PHONE" runat="server" Width="100" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField17" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <%-- EMAIL text editor--%>
                                                <ext:Column ID="EMAIL" ItemID="CHR_EMAIL" DataIndex="EMAIL" runat="server" Width="120" Align="left">
                                                    <Editor>
                                                        <ext:TextField ID="TextField23" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <%-- 1차사(HMC/KMC 기준) text editor--%>
                                                <ext:Column ID="F_CORP" ItemID="F_CORP" DataIndex="F_CORP" runat="server" Width="100" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField19" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>

                                                <%-- SQ 인증유무 COMBO editor--%>
                                                <ext:Column ID="SQ_YN" ItemID="SQ_YN4" DataIndex="SQ_YN" runat="server" Width="100" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField21" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                <ext:Column ID="R_ID" ItemID="R_ID" DataIndex="R_ID" runat="server" Width="100" Align="center" Hidden="true" />                                                
                                                <%-- 2차사(HMC/KMC 기준) text editor--%>
                                                <ext:Column ID="REMARK" ItemID="ETC1"  DataIndex="REMARK" runat="server" Width="200" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField20" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
<%--                                                <ext:Column ID="Column6" ItemID="SQ_YN4" DataIndex="SQ_YN" runat="server" Width="100" Align="center">
                                                    <Editor>
                                                    </Editor>
                                                </ext:Column>   --%>
                                            </Columns>
                                        ...
                                        <Loader ID="Loader6" runat="server" AutoLoad="false" Mode="Data">
                                            <LoadMask ShowMask="true" />
                                        </Loader>
                                        <View>
                                            <ext:GridView ID="GridView6" runat="server"  EnableTextSelection="true"/>
                                        </View>
                                        <SelectionModel>                            
                    ...
                    <%-- 8.관계사현황(계열사), 9.해외진출현황--%>
                    <ext:Panel ID="pnl01_AFF_GRP" runat="server"  Width="940" StyleSpec="margin-right:10px; float:left;" Hidden="true">
                        <Items>
                    ...
                    <%--7.주주현황, 10.연혁  직수출 협력사 현황에서는 사용하지 않아서 HIDDEN처리 --%>
                    <ext:Panel ID="pnl01_ABR_GRP" runat="server" Width="550" Hidden="true" >
                        <Items>
                    ...
                    <ext:Panel ID="pnl01_STCK_GRP" runat="server" Width="550" StyleSpec="margin-right:10px; float:left;" Hidden="true">
                        <Items>
                    ...
                    <ext:Panel ID="pnl01_HIS_GRP" runat="server"  Width="940"  Hidden="true">
                        <Items>
                    ...
                    <ext:Panel ID="pnl01_FIN_GRP" runat="server" Width="660" StyleSpec="margin-right:10px; float:left;" Hidden="true" >
                        <Items>
                    ...
                    <ext:Panel ID="pnl01_SQ_GRP" runat="server"  Width="830"  Hidden="true">
                        <Items>
                            <ext:Label ID="lbl01_TIT_SQ" runat="server" Cls="bottom_area_title_name"/><%--Text="SQ MARK인증"--%>
                            <ext:Panel ID="pnl01_SQ" Cls="excel_upload_area_table" runat="server">
                                <Content>
                                    <table style="width:830px !important">
                                        ...
                                        <tr>
                                            ...
                                            <td class="vt_am">
                                                <epc:EPCodeBox ID="cdx01_SQ_CATEGORY1" runat="server" ClassID="VC" PopupMode="Search" PopupType="CodeWindow" WidthTYPECD="40" />
                                            </td>
                                            <td class="vt_am">
                                            ...
                                            <td class="vt_am"><ext:TextField ID="txt01_MAIN_CHARGE1"  runat="server" Width="165" Cls="inputText" /></td>
                                        </tr>
                                        <tr>
                                            <td class="vt_am" style="height:50px !important;">
                                            ...
                                            <td class="vt_am" >
                                                <epc:EPCodeBox ID="cdx01_SQ_CATEGORY2" runat="server" ClassID="VC" PopupMode="Search" PopupType="CodeWindow" WidthTYPECD="40"/>
                                            </td>
                                            <td class="vt_am">
                                            ...
                                            <td class="vt_am"><ext:TextField ID="txt01_MAIN_CHARGE2"  runat="server" Width="165" Cls="inputText" /></td>
                                        </tr>
                                        <tr>
                                            <td class="vt_am" style="height:50px !important;">
                                            ...
                                            <td class="vt_am" >
                                                <epc:EPCodeBox ID="cdx01_SQ_CATEGORY3" runat="server" ClassID="VC" PopupMode="Search" PopupType="CodeWindow" WidthTYPECD="40"/>
                                            </td>
                                            <td class="vt_am">
                                            ...
                                            <td class="vt_am"><ext:TextField ID="txt01_MAIN_CHARGE3"  runat="server" Width="165" Cls="inputText" /></td>
                                        </tr>
                                    </table>
                                </Content>
                            </ext:Panel>
                    ...
                    <%--13.주요공급업체 매입현황 직수출 협력사 현황에서는 사용하지 않아서 HIDDEN 처리--%>                    
                    <ext:Panel ID="pnl01_PUR" runat="server" Region="North" style="height:200px; width:1500px !important; margin-bottom: 10px;" Hidden="true" >
                        <Content>
                                    ...
                                    <ext:GridPanel ID="Grid03" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display..." Height="152">
                                        ...
                                        <ColumnModel ID="ColumnModel3" runat="server">
                                            <Columns>
                                                ...
                                                <%-- 일반 text editor--%>
                                                <ext:Column ID="VENDNM1" ItemID="VENDNM" DataIndex="VENDNM1" runat="server" Width="500" Align="Left"><%--Text="업체명" --%>
                                                    <Editor>
                    ...
                    <%--15.기타--%>
                    <ext:Label ID="lbl01_TIT_ETC"  runat="server" Cls="bottom_area_title_name" Hidden="true" /><%--Text="기타--%>
                    <ext:Panel ID="pnl01_ETC" Cls="excel_upload_area_table" runat="server"  StyleSpec="width:1500px !important;"  Hidden="true">
                        <Content>
                            <table>
                                <colgroup> 
                                    <col style="width: 100px;" />
                    ...
                    <%--업로드--%>
                    <ext:Panel ID="pnl01_UPLOAD" runat="server" Region="North" Height="304px" StyleSpec="width:1500px !important;">
                        <Content>                        
                            <%--17.1. 주요설비현황(생산설비)--%>                
                            <ext:Panel ID="Panel21" runat="server" Region="North" Height="24" Hidden="false" >
                                <Items> 
                                    <ext:Panel ID="Panel22" runat="server" StyleSpec="margin-right:10px; float:left;" Width="500" Hidden="false">
                                        <Items>
                                            <ext:Label ID="lbl01_TIT_CETI_UPLOAD" runat="server" Cls="bottom_area_title_name2" Width="300px" Text="서연이화 거래 품목정보(2차~4차 협력사 현황) 인증서 업로드"/>
                                        </Items>
                                    </ext:Panel>
                                    <ext:Panel ID="Panel23" runat="server" Width="897" Hidden="false" Cls="bottom_area_btn" >
                                        <Items>
                                            
                                            <ext:FieldContainer ID="FieldContainer1" runat="server" Width="410" MinWidth="410" Flex="1" MsgTarget="Side" Layout="TableLayout">
                                                <Items>                                            
                                                </Items>
                                            </ext:FieldContainer>                                               
                                         </Items>
                            ...
                            <ext:Panel ID="Panel25" Region="North" Border="True" runat="server" Cls="grid_area" >
                                <Items> 
                                    <ext:GridPanel ID="GridPanel77" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display..."  Height="300">
                                        <Store>
                                            <ext:Store ID="Store12" runat="server" PageSize="50">
                                                <Model>
                                                    <ext:Model ID="Model13" runat="server" Name="ModelGrid77">
                                                        <Fields>
                                                            <%--임의로 생성--%>
                                                            <ext:ModelField Name="NO" /> 
                                                            <ext:ModelField Name="CHECK_VALUE" DefaultValue="false" Type="Boolean" /> <%--선택체크박스--%>
                                                            ...
                                                            <%--실제 디비에서 가져와서 사용함.--%>                                                            
                                                            <EXT:MODELFIELD NAME="FILE_NAME" />                                                            
                                                            <EXT:MODELFIELD NAME="FILE_DATA" />
                                                            <EXT:MODELFIELD NAME="SUB_VENDNM" />
                                                            <EXT:MODELFIELD NAME="R_ID" />
                                                    
                                                            <%--DELETE ROW가 존재시--%>
                                                            <EXT:MODELFIELD NAME="NEW" />                                                            
                                                            <ext:ModelField Name="ISNEW" Type="Boolean" />                     
                                                        </Fields>
                                                    </ext:Model>
                                                </Model>
                                        ...
                                        <Plugins>
                                            <ext:BufferedRenderer ID="BufferedRenderer7"  runat="server"/>
                                        ...
                                        <ColumnModel ID="ColumnModel7" runat="server">
                                            <Columns>
                                                <%--NO컬럼--%>
                                                <%--<ext:RowNumbererColumn ID="NO" runat="server" Width="40" Text="No" Align="Center" />--%>   <%-- 자동으로 numbering을 해줌. --%>
                                                <ext:Column ID ="Column6" Text="NO" runat="server" MenuDisabled="true"  Width="40" Align="Center" >
                                                    <Renderer Fn="rendererNo"></Renderer>
                                                </ext:Column>
                                                <%--선택체크박스--%>
                                                <ext:CheckColumn runat="server" ID ="CheckColumn6" Text=""  DataIndex="CHECK_VALUE" Width="35" 
                                                                 StopSelection="false" MenuDisabled="true" Resizable="false" Selectable="true"  Sortable="false"  Editable="true">
                                                </ext:CheckColumn>  
                                                <ext:Column ID="UP_SUB_VENDNM" ItemID="COOPER_NM2" DataIndex="SUB_VENDNM" runat="server" Width="150" Align="center">
                                                    <Editor>
                                                        <ext:TextField ID="TextField22" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                    </Editor>
                                                </ext:Column>
                                                 <ext:Column ID="UP_NAME" runat="server" Text="File Name" DataIndex="FILE_NAME" Width="250" />  
                                                 <ext:Column ID="NEW" runat="server" Text="신규여부" DataIndex="NEW" Width="100" Align="center" />
                                                 <ext:ImageCommandColumn ID="ImageCommandColumn1" MenuDisabled="true" Resizable="false" Sortable="false" runat="server" Width="30" Align="Center">
                                                   <Commands>
                                                      <ext:ImageCommand Icon="LinkGo" ToolTip-Text="파일 보기" CommandName="search" Style="margin: 3px 0px 0px 2px !important;" />      
                                                   </Commands>
                                                   <Listeners>
                                                      <Command Fn="PopupHandler_File" />                                         
                                                   </Listeners>
                                                 </ext:ImageCommandColumn>
                                            </Columns>                                                                 
                                        </ColumnModel>
                                         <TopBar>
                                             <ext:Toolbar ID="Toolbar1" runat="server"  >
                                                 <Items>
                                                    ...
                                                    <ext:Button ID="ButtonRemove" runat="server" TextAlign="Center" Cls="mg_r4" Width="72px" StyleSpec="margin-left:10px;margin-bottom:10px;" Text="DB Delete" Icon="Delete">
                                                        <DirectEvents>
                                                            <Click OnEvent="Remove_ASRM2180_FILE" >
                                                                <Confirmation ConfirmRequest="true" Title="Confirm" Message="Do you want delete?"></Confirmation>     
                                                                <ExtraParams>
                                                                    <ext:Parameter Name="Values" Value="App.GridPanel77.getRowsValues({dirtyRowsOnly: true})" Mode="Raw" Encode="true" />
                                                                </ExtraParams>
                                                            </Click>
                                                        </DirectEvents>
                                                    </ext:Button>    
                                                        ...
                                                        <Listeners>                                                            
                                                            <Click Handler =" 
                                                                    if (App.cdx01_VENDCD_OBJECTID.getValue() == '') {
                                                                        ...
                                                                        Ext.Msg.confirm('알림', 'Do you want save?', function (btn) {
                                                      ...
                                                      <ext:Button ID="Button5" 
                                                         ...
                                                         Handler="
                                                                    if (App.cdx01_VENDCD_OBJECTID.getValue() == '') {
                                                                        ...
                                                                        Ext.Msg.confirm('알림', 'NEW인 모든 행을 삭제 하시겠습니까?', function (btn) {
                                                                                if (btn == 'yes') {
                                                                                    #{MultiUpload1}.removeAllUploads();
                                                                                }
                                                                            }); 
                                                                    }          "  
                                                         />
                                        ...
                                        <Loader ID="Loader7" runat="server" AutoLoad="false" Mode="Data">
                                            <LoadMask ShowMask="true" />
                                        </Loader>
                                        <View>
                                            <ext:GridView ID="GridView7" runat="server"  EnableTextSelection="true"/>
                                        </View>
                                        <SelectionModel>                            
                    ...
                    <%--직수출 협력사 현황에서는 사용하지 않음--%>
                    <ext:Panel ID="Panel18" Hidden="true" runat="server"  style="height:370px;width:490px !important;margin-right: 10px;float:left;">
                        <Content> 
                             <table>
                                <tr > 
                                    <th>
                    ...
                    <ext:Panel ID="pnl01_FAC" runat="server" Region="North" style="height:370px; width:1000px !important;margin-bottom: 10px;">
                        <Content>                        
                            ...
                            <ext:Panel ID="GridPanel01" Region="North" Border="True" runat="server" Cls="grid_area" style="margin-bottom: 10px" >
                                <Items> 
                                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display..."  Height="336">
                                        <Store>
                                        ...
                                        <ColumnModel ID="ColumnModel1" runat="server">
                                            <Columns>
                                                ...
                                                <%-- 일반 text editor--%>
                                                <ext:Column ID="FACILNM" ItemID="FACILNM" DataIndex="FACILNM1" runat="server" Width="200" Align="Left"><%--Text="설비명" --%>
                                                    <Editor>
                             ...
                             <%--17.2.주요설비현황(실험 및 측정설비) 직수출 협력사 현황에서는 사용하지 않음--%>    
                            <ext:Panel ID="ButtonPanel02" runat="server" Region="North" Height="23" Hidden="true" >
                                <Items> 
                            ...
                            <ext:Panel ID="GridPanel02" Region="Center" Border="True" runat="server" Cls="grid_area" Hidden="true" >
                                <Items>  
                                    <ext:GridPanel ID="Grid02" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display..." Height="152">
                                        ...
                                        <ColumnModel ID="ColumnModel2" runat="server">
                                            <Columns>
                                                ...
                                                <%-- 일반 text editor--%>
                                                <ext:Column ID="EQUIPNM" ItemID="EQUIPNM" DataIndex="EQUIPNM1" runat="server" Width="200" Align="Left"><%--Text="설비명" --%>
                                                    <Editor>
