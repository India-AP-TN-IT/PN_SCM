<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_VM20001.aspx.cs" Inherits="Ax.EP.WP.Home.SRM_VM.SRM_VM20001" %>
...
<%--
* 중요사항
4.X에서는 HEIGHT, WIDTH, REGION등 명확하게 지정되어야 한다.
4.X에서 CellSelectionModel이 있으면 프로그램 실행이 보여지지 않음 -> 찾아볼것 
4.X에서 또한 CellSelectionModel와 CHECKCOLUMN은 동일하게 사용되지 않음
--%>
...
<body>
    ...
    <ext:TextField ID="VEND_DIV" runat="server" Hidden="true"></ext:TextField> <%--VENDCD 권한처리 때문--%>
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            ...
            <ext:Panel ID="TitlePanel" Region="North" runat="server" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_VM20001" runat="server" Cls="search_area_title_name"/><%--Text="업체 기본현황 작성" />--%>
                    ...
                    <table style="height:0px;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <epc:EPCodeBox ID="cdx03_VENDCD" runat="server" HelperID="HELP_VENDCD_FREE" PopupMode="Search" PopupType="HelpWindow"
                                        OnBeforeDirectButtonClick="cdx03_UP_VEND_BeforeDirectButtonClick" OnAfterValidation="cdx03_VENDCD_AfterValidation"/>
                            </td>   
                            <td >                               
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="5" style="padding:3px 10px 3px 10px !important;">
                                        <ext:Panel ID="ImagePanel" runat="server"  Width="150px" Border="False" BodyStyle="overflow-y:auto;" Height="140px">
                                            <Items>
                                                <ext:Image ID="img01_REP_PHOTO" runat="server" Align="Middle" Height="138px" >
                    ...
                    <ext:Panel ID="pnl01_ITEM" Cls="excel_upload_area_table" runat="server"  StyleSpec="width:1500px !important;">
                        <Content>
                            <table>
                                ...
                                <tr>
                                    <th>
                                        <ext:Label ID="lbl01_DELI_LINE_LOC" runat="server" /><%--Text="주요납품선(현지어)" /> 4.X heihgt 무조껀지정 --%>
                                    </th>
                                    <td class="line">
