<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA22011P1.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_QA.SRM_QA22011P1" %>
...
<body>
    <form id="SRM_QA22011P1" runat="server">
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_QA22011P1" runat="server" /><%--Text="품명조회" />--%>
