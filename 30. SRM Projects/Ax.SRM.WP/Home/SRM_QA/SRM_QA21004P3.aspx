<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA21004P3.aspx.cs" Inherits="Ax.EP.WP.Home.SRM_QA.SRM_QA21004P3" %>
...
<body>
    <form id="SRM_QA21004P3" runat="server">
    ...
    <ext:TextField ID="txt01_OCCUR_DIV" runat="server" Hidden="true"></ext:TextField> 
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" >
                <Items>
                    <ext:Label ID="lbl01_SRM_QA21004P3" runat="server" Cls="search_area_title_name" /><%--Text="FIELD CLAIM 업체 변제 LIST 출력" />--%>
