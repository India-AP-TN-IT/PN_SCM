...
namespace Ax.EP.WP.Home.SRM_QA
{
    ...
    /// - 작 성 일 : 2014-09-02<br />
    /// </summary>
    public partial class SRM_QA22001P2 : BasePage
    {
        #region [초기설정]
        /// <summary>
        /// PopCustItemcdGrid 생성자
        /// </summary>
        public SRM_QA22001P2()
        {
        ...
        public void GridDataBind()
        {
            try
            {
                ...
                result = EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", "APG_SRM_QA22001", "INQUERY"), param);
                ...
                param.Add("LANG_SET", this.UserInfo.LanguageShort);
                param.Add("USER_ID", this.UserInfo.UserID);
                result = EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", "APG_SRM_QA22001", "INQUERY_MEAS_LIST"), param);
                ...
                param.Add("USER_ID", this.UserInfo.UserID);
                result = EPClientHelper.ExecuteDataSet("APG_SRM_QA22001.INQUERY_MEAS_PHOTO", param);
        ...
        public void Save(DirectEventArgs e)
        {
            ...
            {
               proxy.ExecuteNonQueryTx("APG_SRM_QA22001.SAVE_MEAS", save);
        ...
        public bool IsSaveValid(Dictionary<string, string> param)
        {
            ...
            if (!DateTime.Now.ToString("yyyy-MM-dd").Equals(((DateTime)this.df01_WRITE_MONTH.Value).ToString("yyyy-MM-dd")))
            {
                ...
                DataSet result = EPClientHelper.ExecuteDataSet("APG_SRM_QA22001.INQUERY_MEAS_EXISTS", set);
        ...
        {             
            ...
            DataSet result = EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", "APG_SRM_QA22001", "INQUERY_MEAS"), set);
