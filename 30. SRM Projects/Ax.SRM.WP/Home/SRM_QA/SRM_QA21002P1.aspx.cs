...
{
    public partial class SRM_QA21002P1 : BasePage
    {
        #region [ 초기설정 ]
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    this.df01_PROC_DATE.Text = DateTime.Parse(HttpUtility.ParseQueryString(sQuery).Get("PROC_DATE")).ToString("yyyy-MM");
                    this.txt01_DOCRPTNO.Text = HttpUtility.ParseQueryString(sQuery).Get("DRCRPTNO");
                    this.txt01_CLAIM_OCCUR_DIV.Text = HttpUtility.ParseQueryString(sQuery).Get("CLAIM_OCCUR_DIV");
        ...
        public void GridDataBind()
        {
            try
            {
                ...
                param.Add("PROC_DATE", ((DateTime)this.df01_PROC_DATE.Value).ToString("yyyy-MM"));
                param.Add("DOCRPTNO", this.txt01_DOCRPTNO.Text);
                ...
                result = EPClientHelper.ExecuteDataSet("APG_SRM_QA21002.INQUERY_TNO", param);
