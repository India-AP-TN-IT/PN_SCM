<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA22001P1.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_QA.SRM_QA22001P1" %>
...
<body>
    <form id="SRM_QA22001P1" runat="server">
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_QA22001P1" runat="server" /><%--Text="품명조회" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_INSPECT_CLASSCD2" runat="server" /><%--Text="품명코드" --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_INSPECT_CLASSCD" runat="server" Width="120">
                                    <Listeners>
                                        <Change Handler="App.txt01_INSPECT_CLASSNM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl01_INSPECT_CLASSNM2" runat="server" /><%--Text="품명" --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_INSPECT_CLASSNM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <Model>
                                    <ext:Model runat="server">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="INSPECT_CLASSNM" />
                                        </Fields>
                                    </ext:Model>
                                </Model>
                                <Listeners>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="INSPECT_CLASSCD" ItemID="INSPECT_CLASSCD2" runat="server" DataIndex="INSPECT_CLASSCD" Width="120" Align="Center" /><%--Text="품명코드" --%>
                                <ext:Column ID="INSPECT_CLASSNM" ItemID="INSPECT_CLASSNM2" runat="server" DataIndex="INSPECT_CLASSNM" fLEX="1" MinWidth="150" Align="Left" /><%--Text="품명" --%>
