<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA20002P2.aspx.cs" Inherits="Ax.EP.WP.Home.SRM_QA.SRM_QA20002P2" %>
...
<body>
    ...
    <ext:TextField runat="server" ID="txt01_DEFNO" Hidden="true" />
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_QA20002P2" runat="server" Cls="search_area_title_name" /><%--Text="" />--%>
                        ...
                        <tr>
                            ...
                            <td>
                               <ext:FieldContainer ID="FieldContainer3" runat="server" Width="549" Flex="1" MsgTarget="Side" Layout="TableLayout">
                                    <Items>
                                        <ext:FileUploadField ID="fud01_FILEID1" runat="server" Flex="1" Cls="inputText" ButtonText="Upload" Width="300">
                                        </ext:FileUploadField>
