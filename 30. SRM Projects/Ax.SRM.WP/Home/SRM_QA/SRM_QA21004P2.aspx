<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA21004P2.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_QA.SRM_QA21004P2" %>
...
<body>
    <form id="SRM_QA21004P2" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="0">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_QA21004P2" runat="server" /> <%--Text="이의제기 공문" --%>
            ...
            <ext:Panel ID="ButtonPanel" runat="server" Height="30" Cls="search_area_title_btn">
                ...
                <ext:Label runat="server" Cls="pop_t_01" Text="서연이화용"></ext:Label>
                ...
                <ext:Panel ID="ContentPanel1" runat="server" Cls="search_area_table" Height="270">
                    ...
                    <colgroup>
                        ...
                        <tr>
                            ...
                            <td>
                                <ext:TextField ID="txt02_REQT_SUBJECT" Cls="inputText" FieldCls="inputText" runat="server" ReadOnly="true" Editable="true" Height ="22" Width="420" />
                            </td>
                        </tr> 
                        <tr>
                            <th>
                            ...
                            <td>
                                <ext:TextArea ID="txt02_REQT_REASON" runat="server" ReadOnly="true" Width="420" Height="100" Cls="textarea_m3" />                               
                            </td>
                        </tr> 
 <tr>
                            <th>
                            ...
                            <td>
                                <ext:FieldContainer ID="FieldContainer3" runat="server" Width="549" Flex="1" MsgTarget="Side" Layout="TableLayout">
                                    <Items>
                                        <ext:FileUploadField ID="fud02_FILEID1" runat="server" Cls="inputText" ButtonText="" Width="0" Hidden="true">
                                        </ext:FileUploadField>
                                        <ext:HyperlinkButton ID="lkb02_FILEID1" runat="server" Icon="Attach" Width="549" StyleSpec="color:#000;float:left;overflow:hidden">
                         ...
                         <tr>
                            ...
                            <td>
                                <ext:FieldContainer ID="FieldContainer1" runat="server" Width="549" Flex="1" MsgTarget="Side" Layout="TableLayout">
                                    <Items>
                                        <ext:FileUploadField ID="fud02_FILEID2" runat="server" Cls="inputText" ButtonText="Upload" Width="0" Hidden="true">
                                        </ext:FileUploadField>
                ...
                <ext:Panel ID="Panel2" runat="server" Cls="search_area_table">
                    ...
                    <colgroup>
                        ...
                        <tr>
                            ...
                            <td>
                                <ext:TextField ID="txt02_RSLT_SUBJECT" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" Width="420" />
                            </td>
                        </tr> 
                        <tr>
                            <th>
                            ...
                            <td>
                                <ext:TextArea ID="txt02_RSLT_CNTT" runat="server" Width="420" Height="100" Cls="textarea_m3" />                                
                            </td>
                        </tr> 
                    </table>
                    </Content>
