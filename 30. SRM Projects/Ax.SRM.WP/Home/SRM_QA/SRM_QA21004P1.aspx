<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA21004P1.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_QA.SRM_QA21004P1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_UserSetValues(popupID, objectID, typeNM, typeCD, record) {
            ...
            parent.App.txt01_FORMOBJNO.setValue(typeCD);
        }
...
<body>
    <form id="SRM_QA21004P1" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_QA21004P1" runat="server" Cls="search_area_title_name" /> <%--Text="기간별 통보서번호 조회" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_BEG_MONTH" runat="server" />
                            </th>
                            <td>
                                <ext:DateField ID="df01_FYM" type="Month" runat="server" ReadOnly="true" Width="80" />
                            </td>
                            <th>
                                <ext:Label ID="lbl01_END_MONTH" runat="server" />
                            </th>
                            <td>
                                <ext:DateField ID="df01_TYM" type="Month" runat="server" ReadOnly="true" Width="80" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="DOCRPTNO" ItemID="DOCRPTNO" runat="server" DataIndex="DOCRPTNO" Width="150" Align="Center" />
                                <ext:Column ID="FORMOBJNO" ItemID="FORMOBJNO" runat="server" DataIndex="FORMOBJNO" Width="150" Align="Center" />
                                <ext:Column ID="Column1" ItemID="Column1" runat="server" DataIndex="Column1" MinWidth="10" Align="Center" Flex="1"/>
                            </Columns>
                        </ColumnModel>
