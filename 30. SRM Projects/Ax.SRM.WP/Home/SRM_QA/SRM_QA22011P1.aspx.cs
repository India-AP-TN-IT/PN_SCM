...
{
    /// <summary>
    /// <b>품질팝업 > INSPECT_CLASSCD 조회</b>
    /// - 작 성 자 : 배명희<br />
    /// - 작 성 일 : 2014-09-30<br />
    /// </summary>
    public partial class SRM_QA22011P1 : BasePage
    {
        /// <summary>
        /// PopCustItemcdGrid 생성자
        /// </summary>
        public SRM_QA22011P1()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    this.txt01_INSPECT_CLASSCD.Text = HttpUtility.ParseQueryString(sQuery).Get("CODE");
                    this.txt01_INSPECT_CLASSNM.Text = HttpUtility.ParseQueryString(sQuery).Get("TEXT");
        ...
        public void GridPanel_RowDblClick(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                X.Js.Call("fn_sendParentWindow", this.txt01_ID.Text, parameters[0]["INSPECT_CLASSCD"], parameters[0]["INSPECT_CLASSNM"], parameters[0]["INSPECT_CLASSCD"], JSON.Serialize(parameters[0]));
            }
            catch (Exception ex)
            {
                this.ErrorMessageAlert(this, ex);  // Error message server logging and Display message on UI Screen
        ...
        public void GridDataBind()
        {
            try
            {
                ...
                param.Add("INSPECT_CLASSCD", this.txt01_INSPECT_CLASSCD.Value);
                param.Add("INSPECT_CLASSNM", this.txt01_INSPECT_CLASSNM.Value);
                param.Add("LANG_SET", Util.UserInfo.LanguageShort);
                param.Add("USER_ID", Util.UserInfo.UserID);

                result = EPClientHelper.ExecuteDataSet("APG_SRM_QA22011.INQUERY_INSPECT_CLASSCD", param);
        ...
        public void Reset()
        {
            this.txt01_INSPECT_CLASSCD.Value = "";
            this.txt01_INSPECT_CLASSNM.Value = "";
        ...
        public void Accept(string json)
        {
            try
            {
                ...
                {
                    X.Js.Call("fn_sendParentWindow", this.txt01_ID.Text, parameter[0]["INSPECT_CLASSCD"], parameter[0]["INSPECT_CLASSNM"], parameter[0]["INSPECT_CLASSCD"], JSON.Serialize(parameter[0]));
                }
                else
                {
