...
namespace Ax.SRM.WP.Home.SRM_QA
{
    ...
    public partial class SRM_QA22011 : BasePage
    {
        private string pakageName = "APG_SRM_QA22011";
        ...
        public void CodeBox_CustomRemoteValidation(object sender, EP.UI.EPCodeBox_ValidationResult rsltSet)
        {
            ...
            DataSet ds = EPClientHelper.ExecuteDataSet("APG_SRM_QA22011.INSPECT_CLASSCD_VALIDATION", param);
