<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA22011.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_QA.SRM_QA22011" %>
...
<body>
    <form id="SRM_QA22011" runat="server">
    ...
    <ext:TextField ID="UserHelpURL" runat="server" Hidden="true" Text="SRM_QA22011P2.aspx"></ext:TextField> 
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_QA22011" runat="server" Cls="search_area_title_name" /><%--Text="X-bar R관리 조회/등록" />--%>
                        ...
                        <tr>
                            ...
                            <td>
                                <epc:EPCodeBox ID="cdx01_INPSECT_CLASSCD" runat="server" HelperID="USER_INPSECT_CLASSCD" PopupMode="Search" PopupType="UserWindow"
                                                ...
                                                UserHelpURL="SRM_QA22011P1.aspx"/>
                            </td>
                        </tr> 
                        <tr>                            
                            <th>
