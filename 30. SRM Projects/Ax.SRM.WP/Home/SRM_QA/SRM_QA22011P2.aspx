<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_QA22011P2.aspx.cs" Inherits="Ax.EP.WP.Home.SRM_QA.SRM_QA22011P2" %>
...
<body>
    <form id="SRM_QA22011P2" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10"  Cls="pdb10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30"  >
                <Items>
                    <ext:Label ID="lbl01_SRM_QA22011P2" runat="server" Cls="search_area_title_name" /><%--Text="측정 데이터 등록/조회 상세 Popup" />--%>
                                                ...
                                                <Content>
                                                    <table style="height:0;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="ess">
                                                                <ext:Label ID="lbl01_MEAS_POINT" runat="server" /><%--Text="측정자" />--%>
                                                            </th>
                                                            <td>
                                                                <ext:TextField ID="txt01_MEAS_NAME" Cls="inputText" FieldCls="inputText" runat="server" Height ="22" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>
                                                            ...
                                                            <td colspan="12">
                                                                ...
                                                                <colgroup>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME1" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME6" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME11" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME16" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME2" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME7" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td> 
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME12" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME17" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME3" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME8" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME13" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME18" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME4" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME9" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME14" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME19" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME5" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME10" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME15" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <ext:TimeField ID="tf01_MEAS_TIME20" Cls="inputDate" Width="60px" Format="HH:mm" AltFormats="HHmm" Increment="30" SelectedTime="00:00" runat="server" Editable="true"   />
                                                                        </td>
                                                                        <td>
