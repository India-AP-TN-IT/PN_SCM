<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EP_XM23006P1.aspx.cs" Inherits="Ax.EP.WP.Home.EPAdmin.EP_XM23006P1" %>
...
<body>
    <form id="EP_XM23006P1" runat="server">
    <%-- Ext.NET 사용 시 필수 입력 --%>
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North" >
                <%--<Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_EP_XM23006P1" runat="server" Text="Notice" />
