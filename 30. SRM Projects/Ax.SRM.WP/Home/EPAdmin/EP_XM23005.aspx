<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EP_XM23005.aspx.cs" Inherits="Ax.EP.WP.Home.EPAdmin.EP_XM23005" %>
...
<body>
    <form id="EP_XM23005" runat="server">
    <ext:ResourceManager ID="ResourceManager1" runat="server">
        <Listeners>
            <DocumentReady Handler="ExtDocumentReady();" />
        </Listeners>
    </ext:ResourceManager>
    <ext:TextField ID="UserHelpURL" runat="server" Hidden="true" Text="../EPAdmin/EP_XM23003P1.aspx"></ext:TextField> 
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>              
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_EP_XM23005" runat="server" Cls="search_area_title_name" Text="협력사 게시판 목록" />
