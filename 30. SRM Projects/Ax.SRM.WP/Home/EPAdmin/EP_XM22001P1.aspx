<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EP_XM22001P1.aspx.cs" Inherits="Ax.SRM.WP.Home.EPAdmin.SRM_EP_XM22001P1" %>
...
<head id="Head1" runat="server">
    ...
    <title>LINECD Search Popup</title>
...
<body>
    <form id="SRM_EP_XM22001P1" runat="server">
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_SRM_EP_XM22001P1" runat="server" /><%--Text="Customer Search" />--%>
            ...
            <ext:Panel ID="ConditionPanel" Region="North" Cls="search_area_table lrmargin10" runat="server">
                <Content>
                    <table style="height:0px">
                        ...
                        <tr>
                            <th>
                                <ext:Label ID="lbl01_LINECD" runat="server" Width="110" /><%--Text="Customer Code"  --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_LINECD" runat="server" Width="100">
                                    <Listeners>
                                        <Change Handler="App.txt01_LINENM.setValue('');" />
                                    </Listeners>
                                </ext:TextField>
                            </td>
                            <th>
                                <ext:Label ID="lbl01_LINENM" runat="server" Width="110" /><%--Text="Customer Name" --%>
                            </th>
                            <td>
                                <ext:TextField ID="txt01_LINENM" runat="server" Width="200" />
                            </td>
                        </tr>
                    </table>
                    <%-- 숨겨 사용하기 ^^;;; --%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel2" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="LINECD" ItemID="LINECD" runat="server" DataIndex="LINECD" Width="70" Align="Center" /><%--Text="라인코드" --%>
                                <ext:Column ID="LINENM" ItemID="LINENM" runat="server" DataIndex="LINENM" Width="250" Align="Left" /><%--Text="라인명" --%>
                                <ext:Column ID="Column1" ItemID="Column1" runat="server" DataIndex="Column1" MinWidth="1" Flex="1" Align="Center" /><%--Text="" --%>
                            </Columns>
                        </ColumnModel>
    ...
    <ext:KeyMap ID="KeyMap1" runat="server" Target="App.txt01_LINECD">
        <Binding>
    ...
    <ext:KeyMap ID="KeyMap2" runat="server" Target="App.txt01_LINENM">
        <Binding>
            <ext:KeyBinding DefaultEventAction="StopEvent" Handler="App.ButtonSearch.fireEvent('click');">
                <Keys>
                    <ext:Key Code="ENTER" />
