<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EP_XM20002P1.aspx.cs" Inherits="Ax.EP.WP.Home.EP_XM.EP_XM20002P1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var fn_sendParentWindow = function (popupID, objectID, typeNM, typeCD, record) {
            parent.fn_GridSetValues(popupID, objectID, typeNM, typeCD, Ext.decode(record));
        }
    </script>
</head>
<body>
    <form id="EP_XM20002P1" runat="server">
            ...
            <ext:Panel ID="TitlePanel" runat="server" Region="North">
                <Content>
                    <div class="popup_area">
                        <h1>
                            <ext:Label ID="lbl01_EP_XM20002P1" runat="server" /><%--Text="메뉴팝업" />--%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server"  ColumnLines="true" StripeRows="true" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel2" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="MENUNM" ItemID="MENUNM" runat="server" DataIndex="MENUNM" Flex="1" Align="Left" /><%--Text="메뉴명" --%>                                
                                <ext:Column ID="PARENTID" ItemID="PARENTID_TM" runat="server" DataIndex="PARENTID" Width="120" Align="Left" /><%--Text="상위메뉴" --%>
                            </Columns>
                        </ColumnModel>
