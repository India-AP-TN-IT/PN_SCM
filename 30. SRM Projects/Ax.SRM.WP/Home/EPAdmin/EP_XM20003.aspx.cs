...
{
    public partial class EP_XM20003 : BasePage
    {
        private string pakageName = "APG_EP_XM20003";        
        ...
        public void Search()
        {
            try
            {
                ...
                {
                    Cell_DoubleClick("Grid01", result.Tables[0].Rows[0]["GROUPID"].ToString());
        ...
        private DataSet getDataSet()
        {
            ...
            return EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", "APG_EP_XM20002", "INQUERY_GROUP"), param);
        }
        ...
        private DataSet getDataSetDetail(string groupID)
        {
            ...
            return EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", pakageName, "INQUERY_GROUP_USER"), param);
        }

        private DataSet getDataSetDetail2(string userID)
        {
            HEParameterSet param = new HEParameterSet();
            param.Add("GROUPID", this.hidGROUPID.Value);
            param.Add("USERID", userID);
            param.Add("LANGUAGE", this.UserInfo.LanguageShort);
            param.Add("SYSTEMCODE", this.cbo01_SYSTEMCODE.Value);
            return EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", pakageName, "INQUERY_AUTH_USER_MENU"), param);
        }
        ...
        private void Save(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                (
                    "USERID", "GROUPID", "MENUID", "SYSTEMCODE",
        ...
        public void Delete(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                DataSet param = Util.GetDataSourceSchema("USERID", "GROUPID", "MENUID", "SYSTEMCODE");
        ...
        [DirectMethod]
        public void Cell_DoubleClick(string gridID, string ID)
        {
            if (gridID.Equals("Grid01"))
            {
                this.hidGROUPID.SetValue(ID);

                DataSet result = getDataSetDetail(ID);
            ...
            {
                this.hidUSERID.SetValue(ID);

                DataSet result = getDataSetDetail2(ID);
