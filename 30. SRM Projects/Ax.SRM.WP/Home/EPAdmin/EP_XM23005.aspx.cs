...
{
    /// <summary>
    /// EP_XM23005 <b>협력사 게시판 목록</b>
    /// </summary>
    public partial class EP_XM23005 : BasePage
    {
        ...
        protected void RowSelect(object sender, DirectEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(parameters[0]["INSERT_ID"].ToString()))
            {
                ...
                Util.UserPopup(this, this.UserHelpURL.Text, param, "HELP_XM23003P1", "Popup", Convert.ToInt32(this.PopupWidth.Text), Convert.ToInt32(this.PopupHeight.Text));
            }
        }
