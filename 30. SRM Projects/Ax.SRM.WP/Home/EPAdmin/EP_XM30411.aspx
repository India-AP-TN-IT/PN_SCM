<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EP_XM30411.aspx.cs" Inherits="Ax.EP.WP.Home.EP_XM.EP_XM30411" %>
...
<body>
    <form id="EP_XM30411" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_EP_XM30411" runat="server" Cls="search_area_title_name" /><%--Text="사용자별 권한 현황" />--%>
