...
namespace Ax.EP.WP.Home.EPAdmin
{
    ...
    /// - 작 성 일 : 2015-10-12<br />
    /// </summary>
    public partial class EP_XM23006P1 : BasePage
    {
        ...
        private void SetDataToComponet(DataTable dataTable)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    this.LabelBefore.Html = "<a href='EP_XM23006P1.aspx?NOTICE_SEQ=" + dataTable.Rows[0]["B_NOTICE_SEQ"].ToString() +
                ...
                {
                    this.LabelAfter.Html = "<a href='EP_XM23006P1.aspx?NOTICE_SEQ=" + dataTable.Rows[0]["F_NOTICE_SEQ"].ToString() +
