<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EP_XM23006.aspx.cs" Inherits="Ax.EP.WP.Home.EPAdmin.EP_XM23006" %>
...
<body>
    <form id="EP_XM23006" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_EP_XM23006" runat="server" Cls="search_area_title_name" Text="공지사항" />
