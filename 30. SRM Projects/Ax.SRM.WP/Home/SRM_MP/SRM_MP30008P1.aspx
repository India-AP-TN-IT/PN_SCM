<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_MP30008P1.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_MP.SRM_MP30008P1" %>
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_MP30008P1" runat="server" Cls="search_area_title_name" /><%--Text="입고품 불량내용 상세조회" />--%>
                    ...
                    <ext:GridPanel ID="Grid01" runat="server" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                                ...
                                <Model>
                                    <ext:Model ID="GridModel1" runat="server">
                                        <Fields>
                                            ...
                                            <ext:ModelField Name="DELI_UCOST"/>
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="DELI_CNT" ItemID="DELI_CNT02" runat="server" DataIndex="DELI_CNT" Width="60" Align="Center" />  <%--Text="발행차수"--%> 
                                ...
                                <ext:NumberColumn ID="DELI_UCOST" ItemID="UCOST" runat="server" DataIndex="DELI_UCOST" Width="80" Align="Right" Format="#,##0" />  <%--Text="단가"--%> 
                                <ext:NumberColumn ID="DELI_AMT" ItemID="AMT" runat="server" DataIndex="DELI_AMT" Width="80" Align="Right" Format="#,##0" />  <%--Text="금액"--%> 
                                <ext:DateColumn ID="ARRIV_DATE" ItemID="ARRIV_DATE" runat="server" DataIndex="ARRIV_DATE" Width="80" Align="Right"  />  <%--Text="입하일자"--%> 
                                <ext:NumberColumn ID="ARRIV_QTY" ItemID="ARRIV_QTY" runat="server" DataIndex="ARRIV_QTY" Width="80" Align="Right" Format="#,##0" />  <%--Text="입하수량"--%> 
                                <ext:NumberColumn ID="ARRIV_AMT" ItemID="ARRIV_AMT" runat="server" DataIndex="ARRIV_AMT" Width="80" Align="Right" Format="#,##0" />  <%--Text="입하금액"--%> 
