...
{
    public partial class SRM_MP30004 : BasePage
    {
        private string pakageName = "APG_SRM_MP30004";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!X.IsAjaxRequest)
                {
                    ...
                    Library.ComboDataBind(this.cbo01_QUT_CODE, Library.GetTypeCode("1L").Tables[0], true, "OBJECT_NM", "OBJECT_ID", true);
                    Reset();
                }
            }
            catch //(Exception ex)
        ...
        public void Reset()
        {
            ...
            this.cbo01_QUT_CODE.SelectedItem.Value = "";
            this.cbo01_QUT_CODE.UpdateSelectedItems(); //꼭 해줘야한다.
            this.df01_QUT_DATE.SetValue(DateTime.Now.ToString("yyyy-MM"));
        ...
        private DataSet getDataSet()
        {
            ...
            param.Add("VAN_PROCESS_TYPE", cbo01_QUT_CODE.Value);
            param.Add("QUWT_DATE", ((DateTime)this.df01_QUT_DATE.Value).ToString("yyyy-MM"));
        ...
        {            
            ...
            {
                this.MsgCodeAlert_ShowFormat("SCMMP00-0023", "df01_QUT_DATE", lbl01_QUT_DATE_MP30004.Text);
                return false;
            }
