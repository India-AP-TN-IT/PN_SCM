<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SRM_SD23003.aspx.cs" Inherits="Ax.SRM.WP.Home.SRM_SD.SRM_SD23003" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
	    .x-grid-cell-VEND_INV_QTY DIV,
	    .x-grid-cell-WH_INV_QTY DIV,
	    .x-grid-cell-CUSTOMER DIV,
	    .x-grid-cell-QTY01 DIV,
	    .x-grid-cell-QTY02 DIV,
	    .x-grid-cell-QTY03 DIV,
	    .x-grid-cell-QTY04 DIV,
	    .x-grid-cell-QTY05 DIV,
	    .x-grid-cell-QTY06 DIV,
	    .x-grid-cell-QTY07 DIV,
	    .x-grid-cell-QTY08 DIV,
	    .x-grid-cell-QTY09 DIV,
	    .x-grid-cell-QTY10 DIV
	    {	
		    border-width:1px;
		    border-style:solid;
    ...
    <script type="text/javascript">
        ...
        var CellFocus = function (selectionModel, record, rowIndex, colIndex) {
            var grid = App.Grid01;// selectionModel.view.ownerCt;
...
<body>
    <form id="SRM_SD23003" runat="server">
    ...
    <ext:Viewport ID="UIContainer" runat="server" Layout="BorderLayout" Padding="10">
        ...
        <Items>
            <ext:Panel ID="TitlePanel" runat="server" Region="North" Height="30">
                <Items>
                    <ext:Label ID="lbl01_SRM_SD23003" runat="server" Cls="search_area_title_name" /><%--Text="물류모니터링" />--%>
                ...
                <Content>
                    <table style="height:0px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <epc:EPCodeBox ID="cdx01_CUSTCD" OnDirectEventChange="Button_Click" runat="server" HelperID="HELP_CUSTCD" PopupMode="Search" PopupType="HelpWindow" WidthTYPECD="60" />
                            </td>
                            <th class="ess">         
                                <ext:Label ID="lbl01_VEND_PLANT" runat="server" /><%--고객사공장--%>
                            </th>
                            <td colspan="3">
                                <ext:SelectBox ID="cbo01_PLANTCD" runat="server"  Mode="Local" ForceSelection="true"
                                    DisplayField="CDNM" ValueField="CD" TriggerAction="All" Width="200" >
                                    <Store>
                ...
                <Items>                    
                    <ext:GridPanel ID="Grid01" runat="server" TrailingBufferZone="20" LeadingBufferZone="15" Height="1000" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                ...
                                <ext:Column ID="VINNM" ItemID="VIN" runat="server" DataIndex="VINNM" Width="60" Align="Left" Locked="true" /><%--Text="차종"      --%>
                                <ext:Column ID="CUST_ITEMCD" ItemID="CUST_ITEM2" runat="server" DataIndex="CUST_ITEMCD" Width="110" Align="Left" /><%--Text="고객사 품목(PART)"--%>
                                <ext:Column ID="CUST_ITEMNM" ItemID="ITEMNM3" runat="server" DataIndex="CUST_ITEMNM" Width="150" Align="Left"  /><%--Text="품목명"--%>
                                <ext:Column ID="ALCCD" ItemID="ALCCD" runat="server" DataIndex="ALCCD" Width="50" Align="Center" /> <%--Text="ALC"--%>   
                                <ext:Column ID="INSTALL_POSNM" ItemID="POSTITLE" runat="server" DataIndex="INSTALL_POSNM" Width="70" Align="Left" /><%--Text="위치"  --%>
                                ...
                                <ext:Column ID="INV_STATUS2" ItemID="INV_STATUS2" runat="server" ><%--Text="재고현황(완제품, 06시준)">--%>
                                    <Columns>                                        
                                        <ext:NumberColumn ID="VEND_INV_QTY" ItemID="VEND_INV_QTY" runat="server" DataIndex="VEND_INV_QTY" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_VEND_INV_QTY" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn> <%--Text="사내"--%>
                                        <ext:NumberColumn ID="WH_INV_QTY" ItemID="WH_INV_QTY" runat="server" DataIndex="WH_INV_QTY" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_WH_INV_QTY" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn> <%--Text="물류사"--%>
                                        <ext:NumberColumn ID="CUST_INV_QTY" ItemID="CUSTOMER" runat="server" DataIndex="CUST_INV_QTY" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_CUST_INV_QTY" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn> <%--Text="고객사"--%>
                                ...
                                <ext:Column ID="SHIP_PLAN" ItemID="SHIP_PLAN" runat="server" ><%--Text="출하계획">--%>
                                    <Columns>
                                        ...
                                        <ext:NumberColumn ID="PLAN_QTY1" ItemID="QTY01" runat="server" DataIndex="PLAN_QTY1" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY1" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY2" ItemID="QTY02" runat="server" DataIndex="PLAN_QTY2" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY2" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY3" ItemID="QTY03" runat="server" DataIndex="PLAN_QTY3" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY3" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY4" ItemID="QTY04" runat="server" DataIndex="PLAN_QTY4" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY4" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY5" ItemID="QTY05" runat="server" DataIndex="PLAN_QTY5" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY5" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY6" ItemID="QTY06" runat="server" DataIndex="PLAN_QTY6" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY6" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY7" ItemID="QTY07" runat="server" DataIndex="PLAN_QTY7" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY7" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY8" ItemID="QTY08" runat="server" DataIndex="PLAN_QTY8" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY8" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY9" ItemID="QTY09" runat="server" DataIndex="PLAN_QTY9" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY9" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                        <ext:NumberColumn ID="PLAN_QTY10" ItemID="QTY10" runat="server" DataIndex="PLAN_QTY10" Width="60" Align="Right" Format="#,##0.###" Sortable="true">
                                            <Editor>
                                                <ext:NumberField ID="txt02_PLAN_QTY10" Cls="inputText_Num" FieldCls="inputText_Num" runat="server" MinValue="0" DecimalPrecision="3"/><%--DecimalPrecision="3" 소수점 3자리 입력 허용.--%>
                                            </Editor>
                                        </ext:NumberColumn>
                                    </Columns>
                                </ext:Column>
                    ...
                    <ext:GridPanel ID="Grid02" runat="server" TrailingBufferZone="20" LeadingBufferZone="15" Height="1000" ColumnLines="true" StripeRows="true" Scroll="Both" TrackMouseOver="true" EnableTheming="true" EmptyText="No Records To Display...">
                        ...
                        <ColumnModel ID="ColumnModel2" runat="server">
                            <Columns>
                                <ext:RowNumbererColumn ID="RowNumbererColumn1" ItemID="NO" runat="server" Text="No" Width="40" Align="Center" Locked="true" />
                                <ext:Column ID="D_PLANTNM" ItemID="VEND_PLANT" runat="server" DataIndex="PLANTNM" Width="100" Align="Left" Locked="true"/><%--Text="고객사공장"      --%>
                                <ext:Column ID="D_VINNM" ItemID="VIN" runat="server" DataIndex="VINNM" Width="50" Align="Center" Locked="true" /><%--Text="차종"      --%>
                                <ext:Column ID="D_CUST_ITEMCD" ItemID="CUST_ITEM2" runat="server" DataIndex="CUST_ITEMCD" Width="110" Align="Left" Locked="true"/><%--Text="고객사 품목(PART)"--%>
                                <ext:Column ID="D_CUST_ITEMNM" ItemID="ITEMNM3" runat="server" DataIndex="CUST_ITEMNM" Width="150" Align="Left" Locked="true" /><%--Text="품목명"--%>
                                <ext:Column ID="D_ALCCD" ItemID="ALCCD" runat="server" DataIndex="ALCCD" Width="60" Align="Center" Locked="true"/> <%--Text="ALC"--%>   
                                <ext:Column ID="D_INSTALL_POSNM" ItemID="POSTITLE" runat="server" DataIndex="INSTALL_POSNM" Width="70" Align="Left" Locked="true" /><%--Text="위치"  --%>
                                <ext:Column ID="D_PARTNO" ItemID="PARTNO" runat="server" DataIndex="PARTNO" Width="120" Align="Left" /><%--Text="PART NO"   --%>
                                <ext:Column ID="D_PARTNM" ItemID="PARTNM" runat="server" DataIndex="PARTNM" Width="180" Align="Left" /><%--Text="PART NAME" --%>
                                <ext:NumberColumn ID="D_PREVDAY_RSLT_QTY" ItemID="PREVDAY_RSLT_QTY2" runat="server" DataIndex="PREVDAY_RSLT_QTY" Width="100" Align="Right" Format="#,##0.###"/><%--Text="고객사전일투입"  --%>
                                <ext:NumberColumn ID="D_VEND_INV_QTY" ItemID="VEND_INV_QTY" runat="server" DataIndex="VEND_INV_QTY" Width="55" Align="Right" Format="#,##0.###"/> <%--Text="사내"--%>
                                <ext:NumberColumn ID="D_WH_INV_QTY" ItemID="WH_INV_QTY" runat="server" DataIndex="WH_INV_QTY" Width="55" Align="Right" Format="#,##0.###"/> <%--Text="물류사"--%>
                                <ext:NumberColumn ID="D_CUST_INV_QTY" ItemID="CUSTOMER" runat="server" DataIndex="CUST_INV_QTY" Width="55" Align="Right" Format="#,##0.###"/> <%--Text="고객사"--%>
                                <ext:NumberColumn ID="D_PLAN_QTY1" ItemID="QTY01" runat="server" DataIndex="PLAN_QTY1" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY2" ItemID="QTY02" runat="server" DataIndex="PLAN_QTY2" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY3" ItemID="QTY03" runat="server" DataIndex="PLAN_QTY3" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY4" ItemID="QTY04" runat="server" DataIndex="PLAN_QTY4" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY5" ItemID="QTY05" runat="server" DataIndex="PLAN_QTY5" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY6" ItemID="QTY06" runat="server" DataIndex="PLAN_QTY6" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY7" ItemID="QTY07" runat="server" DataIndex="PLAN_QTY7" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY8" ItemID="QTY08" runat="server" DataIndex="PLAN_QTY8" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY9" ItemID="QTY09" runat="server" DataIndex="PLAN_QTY9" Width="55" Align="Right" Format="#,##0.###"/>
                                <ext:NumberColumn ID="D_PLAN_QTY10" ItemID="QTY10" runat="server" DataIndex="PLAN_QTY10" Width="55" Align="Right" Format="#,##0.###"/>
                            </Columns>
                        </ColumnModel>
