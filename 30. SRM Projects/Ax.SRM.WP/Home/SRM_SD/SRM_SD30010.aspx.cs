...
{
    public partial class SRM_SD30010 : BasePage
    {
        private string pakageName = "APG_SRM_SD30010";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {                    
                    ...
                    //차종
                    this.SetComboBindVincd(Util.UserInfo.BusinessCode);
                    //고객품목
                    //this.SetComboBindCustItem(Util.UserInfo.BusinessCode, "");
        ...
        public void changeCondition(object sender, DirectEventArgs e)
        {
            try
            {
                ...
                Library.ComboDataBind(this.sbox01_CUST_ITEM, EPClientHelper.ExecuteDataSet("APG_SRM_SD30010.INQUERY_CUST_ITEM", param).Tables[0], true, "CUST_ITEMNM", "CUST_ITEMCD", true);
            }
            catch
            {
            }      
        ...
        */
        ...
        public void SetComboBindVincd(string bizcd)
        {
            try
            {
                ...
                Library.ComboDataBind(this.sbox01_VINCD, EPClientHelper.ExecuteDataSet("APG_SRM_SD30010.INQUERY_VINCD", param4).Tables[0], true, "VINNM", "MODELCD", true);
            }
            catch
            {
            }        
        ...
        /*
        [DirectMethod]
        public void SetComboBindCustItem(string bizcd, string vincd)
        {
            try
            {
                changeCondition(null, null);
                ...
                Library.ComboDataBind(this.sbox01_CUST_ITEM, EPClientHelper.ExecuteDataSet("APG_SRM_SD30010.INQUERY_CUST_ITEM", param2).Tables[0], true, "CUST_ITEMNM", "CUST_ITEMCD", true);                
            }
            catch
            {
            }
        ...
        */
        ...
        public void Reset()
        {
            ...
            /*
            if (this.sbox01_CUST_ITEM.Items.Count > 0)
            {
                this.sbox01_CUST_ITEM.SelectedItem.Index = 0;
                this.sbox01_CUST_ITEM.UpdateSelectedItems(); //꼭 해줘야한다.
            }
            */
        ...
        private DataSet getDataSet()
        {
            ...
            */
            ...
            //param.Add("VEND_ITEM_TYPECD", this.sbox01_CUST_ITEM.Value);
            param.Add("VEND_ITEM_TYPECD", "");
            param.Add("WORK_DIR_DIV", "");
