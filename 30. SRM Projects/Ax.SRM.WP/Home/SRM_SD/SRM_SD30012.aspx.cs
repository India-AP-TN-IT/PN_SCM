...
{
    public partial class SRM_SD30012 : BasePage
    {
        private string pakageName = "APG_SRM_SD30012";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!X.IsAjaxRequest)
                {
                    ...
                    Library.ComboDataBind(this.SelectBox01_PLANT, this.getPlantDataSet(), true, "PLANTNM", "PLANTCD", true);
                    Reset();
                }
            }
            catch //(Exception ex)
        ...
        public void Reset()
        {
            ...
            if (this.SelectBox01_PLANT.Items.Count > 0)
            {
                this.SelectBox01_PLANT.SelectedItem.Value = "";
                this.SelectBox01_PLANT.UpdateSelectedItems(); //꼭 해줘야한다.
            }
        ...
        private DataSet getDataSet()
        {
            ...
            param.Add("VEND_PLANTCD", this.SelectBox01_PLANT.Value);
        ...
        /// </summary>
        /// <returns></returns>
        private DataTable getPlantDataSet()
        {
            HEParameterSet param = new HEParameterSet();
            return EPClientHelper.ExecuteDataSet(string.Format("{0}.{1}", pakageName, "INQUERY_VENDOR_PLANT"), param).Tables[0];
        }
